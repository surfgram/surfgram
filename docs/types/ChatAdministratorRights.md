...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getUserProfilePhotos(123, 123);
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getFile('example text');
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getForumTopicIconStickers('example text', 123);
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getBusinessConnection('example text');
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getMyCommands({} as any, 'example text');
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getMyName('example text');
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getMyDescription('example text');
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getMyShortDescription('example text');
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.setMyDefaultAdministratorRights({} as any, true);
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getMyDefaultAdministratorRights(true);
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getBusinessAccountStarBalance('example text');
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getStickerSet('example text');
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getCustomEmojiStickers(['example text']);
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getMyStarBalance(123, 123);
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getStarTransactions(123, 123);
```
...
```typescript
const chatadministratorrights = new ChatAdministratorRights(rawData, bot);
await chatadministratorrights.getGameHighScores('example text');
```
