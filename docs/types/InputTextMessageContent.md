...
The `InputTextMessageContent` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.forwardMessage({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendContact({
  chatId: 123,
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendPoll({
  chatId: 123,
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendChecklist({
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editChatInviteLink({
  chatId: 123,
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editForumTopic(
  123,
  123,
);
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editGeneralForumTopic(
  123,
  "example text",
);
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editStory({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editUserStarSubscription(
  123,
  "example text",
);
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendGame({
  chatId: 123,
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputTextMessageContent events using:

```typescript
// Type-specific handler
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  console.log('Received:', inputtextmessagecontent);
  // Use fluent methods
  await inputtextmessagecontent.sendMessage(...);
});

// Generic handler
bot.on('inputtextmessagecontent', async (data: InputTextMessageContent) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputTextMessageContent).
