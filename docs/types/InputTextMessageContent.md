...
| entities           | `MessageEntity[]`    |    No    | Optional. List of special entities that appear in message text, which can be specified instead of parse_mode |
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.sendChatAction(123, 'example text');
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editForumTopic(123, 123);
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const inputtextmessagecontent = new InputTextMessageContent(rawData, bot);
await inputtextmessagecontent.editUserStarSubscription(123, 'example text');
```
...
bot.onInputTextMessageContent(async (inputtextmessagecontent: InputTextMessageContent) => {
  // Auto-fills parameters from the inputtextmessagecontent instance
  await inputtextmessagecontent.sendGame({ gameShortName: 'Response' });
});
```
