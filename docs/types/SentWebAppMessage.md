...
| :--- | :--- | :---: | :--- |
| inlineMessageId | `string` | No | Optional. Identifier of the sent inline message. Available only if there is an inline keyboard attached to the message. |

## Fluent Methods

The `SentWebAppMessage` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendMessage({ chatId: "Response" });
});
```
...
| :--- | :--- | :--- |
| `messageId` | `this.inlineMessageId?.id` | Message identifier in the chat specified in from_chat_id |
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.forwardMessage({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendContact({
  chatId: 123,
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendContact({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendPoll({
  chatId: 123,
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendChecklist({
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendDice({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editChatInviteLink({
  chatId: 123,
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editForumTopic(
  123,
  123,
);
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editGeneralForumTopic(
  123,
  "example text",
);
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendGift({ giftId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editStory({ businessConnectionId: "Response" });
});
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `inlineMessageId` | `this.inlineMessageId` | Required if chat_id and message_id are not specified. Identifier of the inline message. |
| `messageId` | `this.inlineMessageId?.id` | Required if inline_message_id is not specified. Identifier of the message to edit. |
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `messageId` | `this.inlineMessageId?.id` | Unique identifier for the target message |
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editUserStarSubscription(
  123,
  "example text",
);
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendGame({
  chatId: 123,
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendGame({ chatId: "Response" });
});
```
...
You can listen for SentWebAppMessage events using:

```typescript
// Type-specific handler
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  console.log('Received:', sentwebappmessage);
  // Use fluent methods
  await sentwebappmessage.sendMessage(...);
});

// Generic handler
bot.on('sentwebappmessage', async (data: SentWebAppMessage) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#SentWebAppMessage).
