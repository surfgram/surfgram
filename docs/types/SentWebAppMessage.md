...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.sendChatAction(123, 'example text');
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editForumTopic(123, 123);
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const sentwebappmessage = new SentWebAppMessage(rawData, bot);
await sentwebappmessage.editUserStarSubscription(123, 'example text');
```
...
bot.onSentWebAppMessage(async (sentwebappmessage: SentWebAppMessage) => {
  // Auto-fills parameters from the sentwebappmessage instance
  await sentwebappmessage.sendGame({ gameShortName: 'Response' });
});
```
