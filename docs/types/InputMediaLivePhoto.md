...
| :--- | :--- | :---: | :--- |
| type | `string` | Yes | Type of the result, must be live\_photo |
...
| caption | `string` | No | Optional. Caption of the live photo to be sent, 0-1024 characters after entities parsing |
| parseMode | `string` | No | Optional. Mode for parsing entities in the live photo caption. See formatting options for more details. |
...
| hasSpoiler | `boolean` | No | Optional. Pass True if the live photo needs to be covered with a spoiler animation |

## Fluent Methods

The `InputMediaLivePhoto` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendContact({
  chatId: 123,
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendPoll({
  chatId: 123,
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendChecklist({
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputmedialivephoto = new InputMediaLivePhoto(rawData, bot);
await inputmedialivephoto.sendGame({
  chatId: 123,
...
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  // Auto-fills parameters from the inputmedialivephoto instance
  await inputmedialivephoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputMediaLivePhoto events using:

```typescript
// Type-specific handler
bot.onInputMediaLivePhoto(async (inputmedialivephoto: InputMediaLivePhoto) => {
  console.log('Received:', inputmedialivephoto);
  // Use fluent methods
  await inputmedialivephoto.sendMessage(...);
});

// Generic handler
bot.on('inputmedialivephoto', async (data: InputMediaLivePhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputMediaLivePhoto).
