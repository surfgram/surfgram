...
The `BotCommandScopeChat` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getUpdates({});
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getWebhookInfo({
  url: 'example text',
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getWebhookInfo({ url: 'Response' });
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getMe({
  text: 'example text',
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getMe({ text: 'Response' });
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getUserProfilePhotos(123, 123);
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getUserProfilePhotos();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getFile('example text');
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getFile();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getChat();
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getChatAdministrators();
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getChatMemberCount();
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getChatMember(123);
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getChatMember();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getForumTopicIconStickers('example text', 123);
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getForumTopicIconStickers();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getUserChatBoosts(123);
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getUserChatBoosts();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getBusinessConnection('example text');
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getBusinessConnection();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getMyCommands({} as any, 'example text');
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getMyCommands();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getMyName('example text');
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getMyName();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getMyDescription('example text');
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getMyDescription();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getMyShortDescription('example text');
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getMyShortDescription();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getChatMenuButton();
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getMyDefaultAdministratorRights(true);
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getMyDefaultAdministratorRights();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getAvailableGifts({
  giftId: 'example text',
  userId: 123,
});
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getBusinessAccountStarBalance('example text');
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getBusinessAccountStarBalance();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getStickerSet('example text');
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getStickerSet();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getCustomEmojiStickers(['example text']);
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getCustomEmojiStickers();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getMyStarBalance(123, 123);
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getMyStarBalance();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getStarTransactions(123, 123);
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getStarTransactions();
});
```
...
```typescript
const botcommandscopechat = new BotCommandScopeChat(rawData, bot);
await botcommandscopechat.getGameHighScores(123, 123);
```
...
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  // Auto-fills parameters from the botcommandscopechat instance
  await botcommandscopechat.getGameHighScores();
});
```
...
You can listen for BotCommandScopeChat events using:

```typescript
// Type-specific handler
bot.onBotCommandScopeChat(async (botcommandscopechat: BotCommandScopeChat) => {
  console.log('Received:', botcommandscopechat);
  // Use fluent methods
  await botcommandscopechat.getUpdates(...);
});

// Generic handler
bot.on('botcommandscopechat', async (data: BotCommandScopeChat) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#BotCommandScopeChat).
