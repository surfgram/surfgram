...
| foursquareType  | `string` |    No    | Optional. Foursquare type of the venue, if known. \(For example, “arts_entertainment/default”, “arts_entertainment/aquarium” or “food/icecream”.\) |
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendChatAction(123, 'example text');
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editForumTopic(123, 123);
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editUserStarSubscription(123, 'example text');
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendGame({ gameShortName: 'Response' });
});
```
