...
The `InputVenueMessageContent` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.forwardMessage({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendContact({
  chatId: 123,
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendPoll({
  chatId: 123,
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendChecklist({
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editChatInviteLink({
  chatId: 123,
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editForumTopic(
  123,
  123,
);
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editGeneralForumTopic(
  123,
  "example text",
);
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editStory({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.editUserStarSubscription(
  123,
  "example text",
);
```
...
```typescript
const inputvenuemessagecontent = new InputVenueMessageContent(rawData, bot);
await inputvenuemessagecontent.sendGame({
  chatId: 123,
...
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  // Auto-fills parameters from the inputvenuemessagecontent instance
  await inputvenuemessagecontent.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputVenueMessageContent events using:

```typescript
// Type-specific handler
bot.onInputVenueMessageContent(async (inputvenuemessagecontent: InputVenueMessageContent) => {
  console.log('Received:', inputvenuemessagecontent);
  // Use fluent methods
  await inputvenuemessagecontent.sendMessage(...);
});

// Generic handler
bot.on('inputvenuemessagecontent', async (data: InputVenueMessageContent) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputVenueMessageContent).
