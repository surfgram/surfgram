...
```typescript
const preparedinlinemessage = new PreparedInlineMessage(rawData, bot);
await preparedinlinemessage.sendChatAction(123, 'example text');
```
...
```typescript
const preparedinlinemessage = new PreparedInlineMessage(rawData, bot);
await preparedinlinemessage.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const preparedinlinemessage = new PreparedInlineMessage(rawData, bot);
await preparedinlinemessage.editForumTopic(123, 123);
```
...
```typescript
const preparedinlinemessage = new PreparedInlineMessage(rawData, bot);
await preparedinlinemessage.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const preparedinlinemessage = new PreparedInlineMessage(rawData, bot);
await preparedinlinemessage.editUserStarSubscription(123, 'example text');
```
...
bot.onPreparedInlineMessage(async (preparedinlinemessage: PreparedInlineMessage) => {
  // Auto-fills parameters from the preparedinlinemessage instance
  await preparedinlinemessage.sendGame({ gameShortName: 'Response' });
});
```
