...
| :---------------- | :-------- | :------: | :---------------------------------------------------------------------------------------------------------------------------- |
| query             | `string`  |    No    | Optional. The default inline query to be inserted in the input field. If left empty, only the bot's username will be inserted |
| allowUserChats    | `boolean` |    No    | Optional. True, if private chats with users can be chosen                                                                     |
| allowBotChats     | `boolean` |    No    | Optional. True, if private chats with bots can be chosen                                                                      |
| allowGroupChats   | `boolean` |    No    | Optional. True, if group and supergroup chats can be chosen                                                                   |
| allowChannelChats | `boolean` |    No    | Optional. True, if channel chats can be chosen                                                                                |

## Fluent Methods

The `SwitchInlineQueryChosenChat` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getUpdates({});
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getWebhookInfo({
  url: 'example text',
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getWebhookInfo({ url: 'Response' });
  }
);
```
...
| :-------- | :------------------------ | :------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.allowUserChats?.id` | Unique identifier for the target chat or username of the target channel (in the format @channelusername) |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getMe({
  text: 'example text',
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getMe({ text: 'Response' });
  }
);
```
...
| Parameter | Source                    | Description                          |
| :-------- | :------------------------ | :----------------------------------- |
| `userId`  | `this.allowUserChats?.id` | Unique identifier of the target user |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getUserProfilePhotos(123, 123);
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getUserProfilePhotos();
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getFile('example text');
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getFile();
  }
);
```
...
| Parameter | Source                    | Description                                                                                                            |
| :-------- | :------------------------ | :--------------------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.allowUserChats?.id` | Unique identifier for the target chat or username of the target supergroup or channel (in the format @channelusername) |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getChat();
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getChatAdministrators();
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getChatMemberCount();
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getChatMember();
```
...
| Parameter | Source                    | Description                                                                                                    |
| :-------- | :------------------------ | :------------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.allowUserChats?.id` | Unique identifier for the target chat or username of the target supergroup (in the format @supergroupusername) |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getForumTopicIconStickers('example text', 123);
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getForumTopicIconStickers();
  }
);
```
...
| Parameter | Source                    | Description                                                                                |
| :-------- | :------------------------ | :----------------------------------------------------------------------------------------- |
| `chatId`  | `this.allowUserChats?.id` | Unique identifier for the chat or username of the channel (in the format @channelusername) |
| `userId`  | `this.allowUserChats?.id` | Unique identifier of the target user                                                       |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getUserChatBoosts();
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getBusinessConnection('example text');
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getBusinessConnection();
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getMyCommands({} as any, 'example text');
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getMyCommands();
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getMyName('example text');
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getMyName();
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getMyDescription('example text');
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getMyDescription();
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getMyShortDescription('example text');
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getMyShortDescription();
  }
);
```
...
| Parameter | Source                    | Description                                                                                                 |
| :-------- | :------------------------ | :---------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.allowUserChats?.id` | Unique identifier for the target private chat. If not specified, default bot's menu button will be returned |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getChatMenuButton();
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getMyDefaultAdministratorRights(true);
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getMyDefaultAdministratorRights();
  }
);
```
...
| Parameter | Source                    | Description                                                                                                                                                  |
| :-------- | :------------------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `userId`  | `this.allowUserChats?.id` | Required if chat_id is not specified. Unique identifier of the target user who will receive the gift.                                                        |
| `chatId`  | `this.allowUserChats?.id` | Required if user_id is not specified. Unique identifier for the chat or username of the channel (in the format @channelusername) that will receive the gift. |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getAvailableGifts({
  giftId: 'example text',
  payForUpgrade: true,
});
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getAvailableGifts({ giftId: 'Response' });
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getBusinessAccountStarBalance('example text');
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getBusinessAccountStarBalance();
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getBusinessAccountGifts({ businessConnectionId: 'Response' });
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getStickerSet('example text');
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getStickerSet();
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getCustomEmojiStickers(['example text']);
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getCustomEmojiStickers();
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getMyStarBalance(123, 123);
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getMyStarBalance();
  }
);
```
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getStarTransactions(123, 123);
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getStarTransactions();
  }
);
```
...
| Parameter | Source                    | Description                                                                           |
| :-------- | :------------------------ | :------------------------------------------------------------------------------------ |
| `userId`  | `this.allowUserChats?.id` | Target user id                                                                        |
| `chatId`  | `this.allowUserChats?.id` | Required if inline_message_id is not specified. Unique identifier for the target chat |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getGameHighScores(123, 'example text');
```
...
bot.onSwitchInlineQueryChosenChat(
  async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
    // Auto-fills parameters from the switchinlinequerychosenchat instance
    await switchinlinequerychosenchat.getGameHighScores();
  }
);
```
...
You can listen for SwitchInlineQueryChosenChat events using:

```typescript
// Type-specific handler
bot.onSwitchInlineQueryChosenChat(async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
  console.log('Received:', switchinlinequerychosenchat);
  // Use fluent methods
  await switchinlinequerychosenchat.getUpdates(...);
});

// Generic handler
bot.on('switchinlinequerychosenchat', async (data: SwitchInlineQueryChosenChat) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#SwitchInlineQueryChosenChat).
