...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getUserProfileAudios(
  123,
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.allowUserChats?.id` | Unique identifier for the target chat or username of the target supergroup or channel in the format @username |
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.allowUserChats?.id` | Unique identifier for the target user |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getUserPersonalChatMessages(
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.allowUserChats?.id` | Unique identifier for the target chat or username of the target supergroup in the format @username |
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.allowUserChats?.id` | Unique identifier for the chat or username of the channel in the format @username |
| `userId` | `this.allowUserChats?.id` | Unique identifier of the target user |
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.allowUserChats?.id` | User identifier of the managed bot whose token will be returned |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getManagedBotToken();
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.allowUserChats?.id` | User identifier of the managed bot whose access settings will be returned |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getManagedBotAccessSettings();
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.allowUserChats?.id` | Unique identifier for the target private chat. If not specified, the bot's default menu button will be returned. |
...
| `chatId` | `this.allowUserChats?.id` | Required if user_id is not specified. Unique identifier for the chat or username of the channel (in the format @username) that will receive the gift. |
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.allowUserChats?.id` | Unique identifier of the user |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getUserGifts({
...
bot.onSwitchInlineQueryChosenChat(async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
  // Auto-fills parameters from the switchinlinequerychosenchat instance
  await switchinlinequerychosenchat.getUserGifts({ offset: "Response" });
});
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.allowUserChats?.id` | Unique identifier for the target chat or username of the target channel in the format @username |
...
```typescript
const switchinlinequerychosenchat = new SwitchInlineQueryChosenChat(rawData, bot);
await switchinlinequerychosenchat.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onSwitchInlineQueryChosenChat(async (switchinlinequerychosenchat: SwitchInlineQueryChosenChat) => {
  // Auto-fills parameters from the switchinlinequerychosenchat instance
  await switchinlinequerychosenchat.getChatGifts({ offset: "Response" });
});
```
