...
| :--- | :--- | :---: | :--- |
| type | `string` | Yes | Scope type, must be all\_group\_chats |
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getUserProfileAudios(
  123,
  123,
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getUserPersonalChatMessages(
  123,
  123,
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getManagedBotToken(
  123,
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getManagedBotAccessSettings(
  123,
);
```
...
bot.onBotCommandScopeAllGroupChats(async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
  // Auto-fills parameters from the botcommandscopeallgroupchats instance
  await botcommandscopeallgroupchats.getBusinessAccountGifts({ businessConnectionId: "Response" });
});
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getUserGifts({
  userId: 123,
...
bot.onBotCommandScopeAllGroupChats(async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
  // Auto-fills parameters from the botcommandscopeallgroupchats instance
  await botcommandscopeallgroupchats.getUserGifts({ offset: "Response" });
});
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onBotCommandScopeAllGroupChats(async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
  // Auto-fills parameters from the botcommandscopeallgroupchats instance
  await botcommandscopeallgroupchats.getChatGifts({ offset: "Response" });
});
```
