...
| :--- | :------- | :------: | :---------------------------------- |
| type | `string` |   Yes    | Scope type, must be all_group_chats |

## Fluent Methods

The `BotCommandScopeAllGroupChats` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getUpdates({});
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getWebhookInfo({
  url: 'example text',
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getWebhookInfo({ url: 'Response' });
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getMe({
  text: 'example text',
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getMe({ text: 'Response' });
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getUserProfilePhotos(123, 123);
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getUserProfilePhotos();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getFile('example text');
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getFile();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getChat();
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getChatAdministrators();
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getChatMemberCount();
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getChatMember(123);
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getChatMember();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getForumTopicIconStickers('example text', 123);
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getForumTopicIconStickers();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getUserChatBoosts(123);
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getUserChatBoosts();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getBusinessConnection('example text');
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getBusinessConnection();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getMyCommands({} as any, 'example text');
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getMyCommands();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getMyName('example text');
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getMyName();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getMyDescription('example text');
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getMyDescription();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getMyShortDescription('example text');
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getMyShortDescription();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getChatMenuButton();
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getMyDefaultAdministratorRights(true);
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getMyDefaultAdministratorRights();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getAvailableGifts({
  giftId: 'example text',
  userId: 123,
});
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getAvailableGifts({ giftId: 'Response' });
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getBusinessAccountStarBalance('example text');
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getBusinessAccountStarBalance();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getStickerSet('example text');
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getStickerSet();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getCustomEmojiStickers(['example text']);
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getCustomEmojiStickers();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getMyStarBalance(123, 123);
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getMyStarBalance();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getStarTransactions(123, 123);
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getStarTransactions();
  }
);
```
...
```typescript
const botcommandscopeallgroupchats = new BotCommandScopeAllGroupChats(rawData, bot);
await botcommandscopeallgroupchats.getGameHighScores(123, 123);
```
...
bot.onBotCommandScopeAllGroupChats(
  async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
    // Auto-fills parameters from the botcommandscopeallgroupchats instance
    await botcommandscopeallgroupchats.getGameHighScores();
  }
);
```
...
You can listen for BotCommandScopeAllGroupChats events using:

```typescript
// Type-specific handler
bot.onBotCommandScopeAllGroupChats(async (botcommandscopeallgroupchats: BotCommandScopeAllGroupChats) => {
  console.log('Received:', botcommandscopeallgroupchats);
  // Use fluent methods
  await botcommandscopeallgroupchats.getUpdates(...);
});

// Generic handler
bot.on('botcommandscopeallgroupchats', async (data: BotCommandScopeAllGroupChats) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#BotCommandScopeAllGroupChats).
