...
| chatId | `number` \| `string` |   Yes    | Unique identifier for the target chat or username of the target supergroup \(in the format @supergroupusername\). Channel direct messages chats and channel chats aren't supported. |

## Fluent Methods

The `BotCommandScopeChatAdministrators` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getUpdates({});
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getWebhookInfo({
  url: 'example text',
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getWebhookInfo({ url: 'Response' });
  }
);
```
...
| :-------- | :------------ | :------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.chatId` | Unique identifier for the target chat or username of the target channel (in the format @channelusername) |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getMe({
  text: 'example text',
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getMe({ text: 'Response' });
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getUserProfilePhotos(123, 123);
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getUserProfilePhotos();
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getFile('example text');
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getFile();
  }
);
```
...
| Parameter | Source        | Description                                                                                                            |
| :-------- | :------------ | :--------------------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.chatId` | Unique identifier for the target chat or username of the target supergroup or channel (in the format @channelusername) |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getChat();
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getChatAdministrators();
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getChatMemberCount();
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getChatMember(123);
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getChatMember();
  }
);
```
...
| Parameter | Source        | Description                                                                                                    |
| :-------- | :------------ | :------------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.chatId` | Unique identifier for the target chat or username of the target supergroup (in the format @supergroupusername) |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getForumTopicIconStickers('example text', 123);
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getForumTopicIconStickers();
  }
);
```
...
| Parameter | Source        | Description                                                                                |
| :-------- | :------------ | :----------------------------------------------------------------------------------------- |
| `chatId`  | `this.chatId` | Unique identifier for the chat or username of the channel (in the format @channelusername) |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getUserChatBoosts(123);
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getUserChatBoosts();
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getBusinessConnection('example text');
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getBusinessConnection();
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getMyCommands({} as any, 'example text');
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getMyCommands();
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getMyName('example text');
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getMyName();
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getMyDescription('example text');
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getMyDescription();
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getMyShortDescription('example text');
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getMyShortDescription();
  }
);
```
...
| Parameter | Source        | Description                                                                                                 |
| :-------- | :------------ | :---------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.chatId` | Unique identifier for the target private chat. If not specified, default bot's menu button will be returned |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getChatMenuButton();
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getMyDefaultAdministratorRights(true);
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getMyDefaultAdministratorRights();
  }
);
```
...
| Parameter | Source        | Description                                                                                                                                                  |
| :-------- | :------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.chatId` | Required if user_id is not specified. Unique identifier for the chat or username of the channel (in the format @channelusername) that will receive the gift. |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getAvailableGifts({
  giftId: 'example text',
  userId: 123,
});
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getAvailableGifts({ giftId: 'Response' });
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getBusinessAccountStarBalance('example text');
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getBusinessAccountStarBalance();
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getStickerSet('example text');
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getStickerSet();
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getCustomEmojiStickers(['example text']);
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getCustomEmojiStickers();
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getMyStarBalance(123, 123);
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getMyStarBalance();
  }
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getStarTransactions(123, 123);
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getStarTransactions();
  }
);
```
...
| Parameter | Source        | Description                                                                           |
| :-------- | :------------ | :------------------------------------------------------------------------------------ |
| `chatId`  | `this.chatId` | Required if inline_message_id is not specified. Unique identifier for the target chat |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getGameHighScores(123, 123);
```
...
bot.onBotCommandScopeChatAdministrators(
  async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopechatadministrators instance
    await botcommandscopechatadministrators.getGameHighScores();
  }
);
```
...
You can listen for BotCommandScopeChatAdministrators events using:

```typescript
// Type-specific handler
bot.onBotCommandScopeChatAdministrators(async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
  console.log('Received:', botcommandscopechatadministrators);
  // Use fluent methods
  await botcommandscopechatadministrators.getUpdates(...);
});

// Generic handler
bot.on('botcommandscopechatadministrators', async (data: BotCommandScopeChatAdministrators) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#BotCommandScopeChatAdministrators).
