...
| :--- | :--- | :---: | :--- |
| type | `string` | Yes | Scope type, must be chat\_administrators |
| chatId | `number` \| `string` | Yes | Unique identifier for the target chat or username of the target supergroup in the format @username. Channel direct messages chats and channel chats aren't supported. |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getUserProfileAudios(
  123,
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.chatId` | Unique identifier for the target chat or username of the target supergroup or channel in the format @username |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getUserPersonalChatMessages(
  123,
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.chatId` | Unique identifier for the target chat or username of the target supergroup in the format @username |
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.chatId` | Unique identifier for the chat or username of the channel in the format @username |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getManagedBotToken(
  123,
);
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getManagedBotAccessSettings(
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.chatId` | Unique identifier for the target private chat. If not specified, the bot's default menu button will be returned. |
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.chatId` | Required if user_id is not specified. Unique identifier for the chat or username of the channel (in the format @username) that will receive the gift. |
...
bot.onBotCommandScopeChatAdministrators(async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
  // Auto-fills parameters from the botcommandscopechatadministrators instance
  await botcommandscopechatadministrators.getBusinessAccountGifts({ businessConnectionId: "Response" });
});
```
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getUserGifts({
  userId: 123,
...
bot.onBotCommandScopeChatAdministrators(async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
  // Auto-fills parameters from the botcommandscopechatadministrators instance
  await botcommandscopechatadministrators.getUserGifts({ offset: "Response" });
});
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.chatId` | Unique identifier for the target chat or username of the target channel in the format @username |
...
```typescript
const botcommandscopechatadministrators = new BotCommandScopeChatAdministrators(rawData, bot);
await botcommandscopechatadministrators.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onBotCommandScopeChatAdministrators(async (botcommandscopechatadministrators: BotCommandScopeChatAdministrators) => {
  // Auto-fills parameters from the botcommandscopechatadministrators instance
  await botcommandscopechatadministrators.getChatGifts({ offset: "Response" });
});
```
