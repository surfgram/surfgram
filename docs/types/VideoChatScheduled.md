...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.sendChatAction('example text', 'example text');
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getUserProfilePhotos(123, 123);
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getFile('example text');
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getChatMember(123);
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getForumTopicIconStickers('example text', 123);
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getUserChatBoosts(123);
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getBusinessConnection('example text');
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getMyCommands({} as any, 'example text');
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getMyName('example text');
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getMyDescription('example text');
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getMyShortDescription('example text');
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getMyDefaultAdministratorRights(true);
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getBusinessAccountStarBalance('example text');
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getStickerSet('example text');
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getCustomEmojiStickers(['example text']);
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getMyStarBalance(123, 123);
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getStarTransactions(123, 123);
```
...
```typescript
const videochatscheduled = new VideoChatScheduled(rawData, bot);
await videochatscheduled.getGameHighScores(123, 123);
```
