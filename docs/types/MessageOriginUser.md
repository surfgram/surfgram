...
```typescript
const messageoriginuser = new MessageOriginUser(rawData, bot);
await messageoriginuser.sendChatAction(123, 'example text');
```
...
```typescript
const messageoriginuser = new MessageOriginUser(rawData, bot);
await messageoriginuser.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const messageoriginuser = new MessageOriginUser(rawData, bot);
await messageoriginuser.editForumTopic(123, 123);
```
...
```typescript
const messageoriginuser = new MessageOriginUser(rawData, bot);
await messageoriginuser.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const messageoriginuser = new MessageOriginUser(rawData, bot);
await messageoriginuser.editUserStarSubscription('example text', true);
```
...
bot.onMessageOriginUser(async (messageoriginuser: MessageOriginUser) => {
  // Auto-fills parameters from the messageoriginuser instance
  await messageoriginuser.sendGame({ gameShortName: 'Response' });
});
```
