...
```typescript
const messageentity = new MessageEntity(rawData, bot);
await messageentity.sendChatAction(123, 'example text');
```
...
```typescript
const messageentity = new MessageEntity(rawData, bot);
await messageentity.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const messageentity = new MessageEntity(rawData, bot);
await messageentity.editForumTopic(123, 123);
```
...
```typescript
const messageentity = new MessageEntity(rawData, bot);
await messageentity.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const messageentity = new MessageEntity(rawData, bot);
await messageentity.editUserStarSubscription('example text', true);
```
...
bot.onMessageEntity(async (messageentity: MessageEntity) => {
  // Auto-fills parameters from the messageentity instance
  await messageentity.sendGame({ gameShortName: 'Response' });
});
```
