...
| :--- | :--- | :---: | :--- |
| inlineMessageId | `string` | Yes | Identifier of the sent inline message |

## Fluent Methods

The `SentGuestMessage` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.forwardMessage({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendContact({
  chatId: 123,
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendContact({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendPoll({
  chatId: 123,
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendChecklist({
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendDice({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editChatInviteLink({
  chatId: 123,
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editForumTopic(
  123,
  123,
);
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editGeneralForumTopic(
  123,
  "example text",
);
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendGift({ giftId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editStory({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.editUserStarSubscription(
  123,
  "example text",
);
```
...
```typescript
const sentguestmessage = new SentGuestMessage(rawData, bot);
await sentguestmessage.sendGame({
  chatId: 123,
...
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  // Auto-fills parameters from the sentguestmessage instance
  await sentguestmessage.sendGame({ chatId: "Response" });
});
```
...
You can listen for SentGuestMessage events using:

```typescript
// Type-specific handler
bot.onSentGuestMessage(async (sentguestmessage: SentGuestMessage) => {
  console.log('Received:', sentguestmessage);
  // Use fluent methods
  await sentguestmessage.sendMessage(...);
});

// Generic handler
bot.on('sentguestmessage', async (data: SentGuestMessage) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#SentGuestMessage).
