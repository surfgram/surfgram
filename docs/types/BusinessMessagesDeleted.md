...
```typescript
const businessmessagesdeleted = new BusinessMessagesDeleted(rawData, bot);
await businessmessagesdeleted.sendChatAction('example text', 123);
```
...
```typescript
const businessmessagesdeleted = new BusinessMessagesDeleted(rawData, bot);
await businessmessagesdeleted.editChatSubscriptionInviteLink('example text', 'example text');
```
...
```typescript
const businessmessagesdeleted = new BusinessMessagesDeleted(rawData, bot);
await businessmessagesdeleted.editForumTopic(123, 'example text');
```
...
```typescript
const businessmessagesdeleted = new BusinessMessagesDeleted(rawData, bot);
await businessmessagesdeleted.editGeneralForumTopic('example text');
```
...
```typescript
const businessmessagesdeleted = new BusinessMessagesDeleted(rawData, bot);
await businessmessagesdeleted.editUserStarSubscription(123, 'example text');
```
