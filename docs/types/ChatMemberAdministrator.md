...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getUserPersonalChatMessages(
  123,
);
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getManagedBotToken();
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getManagedBotAccessSettings();
```
