...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getUserProfilePhotos(123, 123);
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getFile('example text');
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getForumTopicIconStickers('example text', 123);
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getBusinessConnection('example text');
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getMyCommands({} as any, 'example text');
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getMyName('example text');
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getMyDescription('example text');
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getMyShortDescription('example text');
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getMyDefaultAdministratorRights(true);
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getBusinessAccountStarBalance('example text');
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getStickerSet('example text');
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getCustomEmojiStickers(['example text']);
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getMyStarBalance(123, 123);
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getStarTransactions(123, 123);
```
...
```typescript
const chatmemberadministrator = new ChatMemberAdministrator(rawData, bot);
await chatmemberadministrator.getGameHighScores('example text');
```
