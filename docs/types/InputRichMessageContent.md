...
The `InputRichMessageContent` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendMessage({ chatId: "Response" });
});
```
...
| :--- | :--- | :--- |
| `messageId` | `this.richMessage?.id` | Message identifier in the chat specified in from_chat_id |
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.forwardMessage({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendContact({
  chatId: 123,
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendPoll({
  chatId: 123,
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendChecklist({
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editChatInviteLink({
  chatId: 123,
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editForumTopic(
  123,
  123,
);
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editGeneralForumTopic(
  123,
  "example text",
);
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editStory({ businessConnectionId: "Response" });
});
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `messageId` | `this.richMessage?.id` | Required if inline_message_id is not specified. Identifier of the message to edit. |
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `messageId` | `this.richMessage?.id` | Unique identifier for the target message |
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.editUserStarSubscription(
  123,
  "example text",
);
```
...
```typescript
const inputrichmessagecontent = new InputRichMessageContent(rawData, bot);
await inputrichmessagecontent.sendGame({
  chatId: 123,
...
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  // Auto-fills parameters from the inputrichmessagecontent instance
  await inputrichmessagecontent.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputRichMessageContent events using:

```typescript
// Type-specific handler
bot.onInputRichMessageContent(async (inputrichmessagecontent: InputRichMessageContent) => {
  console.log('Received:', inputrichmessagecontent);
  // Use fluent methods
  await inputrichmessagecontent.sendMessage(...);
});

// Generic handler
bot.on('inputrichmessagecontent', async (data: InputRichMessageContent) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputRichMessageContent).
