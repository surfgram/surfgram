...
| :--- | :--- | :---: | :--- |
| inlineKeyboard | `InlineKeyboardButton[][]` | Yes | Array of button rows, each represented by an Array of InlineKeyboardButton objects |

## Fluent Methods

The `InlineKeyboardMarkup` class has the following fluent methods that automatically inject contextual parameters:
...
await inlinekeyboardmarkup.getMe({
  chatId: 123,
  text: "example text",
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  ...
  await inlinekeyboardmarkup.getMe({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.logOut({
  chatId: 123,
  text: "example text",
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.logOut({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.close({
  chatId: 123,
  text: "example text",
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.close({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.copyMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.copyMessage({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendContact({
  chatId: 123,
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendPoll({
  chatId: 123,
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendChecklist({
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.stopMessageLiveLocation({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.stopMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.stopPoll(
  123,
  123,
);
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inlinekeyboardmarkup = new InlineKeyboardMarkup(rawData, bot);
await inlinekeyboardmarkup.sendGame({
  chatId: 123,
...
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  // Auto-fills parameters from the inlinekeyboardmarkup instance
  await inlinekeyboardmarkup.sendGame({ chatId: "Response" });
});
```
...
You can listen for InlineKeyboardMarkup events using:

```typescript
// Type-specific handler
bot.onInlineKeyboardMarkup(async (inlinekeyboardmarkup: InlineKeyboardMarkup) => {
  console.log('Received:', inlinekeyboardmarkup);
  // Use fluent methods
  await inlinekeyboardmarkup.getMe(...);
});

// Generic handler
bot.on('inlinekeyboardmarkup', async (data: InlineKeyboardMarkup) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InlineKeyboardMarkup).
