...
| :--- | :--- | :---: | :--- |
| paidMessageStarCount | `number` | Yes | The new number of Telegram Stars that must be paid by non-administrator users of the supergroup chat for each sent message |

## Fluent Methods

The `PaidMessagePriceChanged` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendMessage({ chatId: "Response" });
});
```
...
| :--- | :--- | :--- |
| `messageId` | `this.paidMessageStarCount?.id` | Message identifier in the chat specified in from_chat_id |
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.forwardMessage({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendContact({
  chatId: 123,
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendContact({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendPoll({
  chatId: 123,
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendChecklist({
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendDice({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editChatInviteLink({
  chatId: 123,
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editForumTopic(
  123,
  123,
);
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editGeneralForumTopic(
  123,
  "example text",
);
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendGift({ giftId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editStory({ businessConnectionId: "Response" });
});
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `messageId` | `this.paidMessageStarCount?.id` | Required if inline_message_id is not specified. Identifier of the message to edit. |
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `messageId` | `this.paidMessageStarCount?.id` | Unique identifier for the target message |
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editUserStarSubscription(
  123,
  "example text",
);
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendGame({
  chatId: 123,
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendGame({ chatId: "Response" });
});
```
...
You can listen for PaidMessagePriceChanged events using:

```typescript
// Type-specific handler
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  console.log('Received:', paidmessagepricechanged);
  // Use fluent methods
  await paidmessagepricechanged.sendMessage(...);
});

// Generic handler
bot.on('paidmessagepricechanged', async (data: PaidMessagePriceChanged) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#PaidMessagePriceChanged).
