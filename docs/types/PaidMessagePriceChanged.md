...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.sendChatAction(123, 'example text');
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editForumTopic(123, 123);
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const paidmessagepricechanged = new PaidMessagePriceChanged(rawData, bot);
await paidmessagepricechanged.editUserStarSubscription(123, 'example text');
```
...
bot.onPaidMessagePriceChanged(async (paidmessagepricechanged: PaidMessagePriceChanged) => {
  // Auto-fills parameters from the paidmessagepricechanged instance
  await paidmessagepricechanged.sendGame({ gameShortName: 'Response' });
});
```
