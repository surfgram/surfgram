...
| photo | `string` | Yes | The static profile photo. Profile photos can't be reused and can only be uploaded as a new file, so you can pass “attach://&lt;file\_attach\_name&gt;” if the photo was uploaded using multipart/form-data under &lt;file\_attach\_name&gt;. More information on Sending Files » |

## Fluent Methods

The `InputProfilePhotoStatic` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendContact({
  chatId: 123,
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendPoll({
  chatId: 123,
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendChecklist({
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotostatic = new InputProfilePhotoStatic(rawData, bot);
await inputprofilephotostatic.sendGame({
  chatId: 123,
...
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  // Auto-fills parameters from the inputprofilephotostatic instance
  await inputprofilephotostatic.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputProfilePhotoStatic events using:

```typescript
// Type-specific handler
bot.onInputProfilePhotoStatic(async (inputprofilephotostatic: InputProfilePhotoStatic) => {
  console.log('Received:', inputprofilephotostatic);
  // Use fluent methods
  await inputprofilephotostatic.sendMessage(...);
});

// Generic handler
bot.on('inputprofilephotostatic', async (data: InputProfilePhotoStatic) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputProfilePhotoStatic).
