...
| documentFileId | `string` | Yes | A valid file identifier for the file |
...
| parseMode | `string` | No | Optional. Mode for parsing entities in the document caption. See formatting options for more details. |
...
| inputMessageContent | `InputMessageContent` | No | Optional. Content of the message to be sent instead of the file |

## Fluent Methods

The `InlineQueryResultCachedDocument` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendContact({
  chatId: 123,
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendPoll({
  chatId: 123,
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendChecklist({
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendGame({
  chatId: 123,
...
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  // Auto-fills parameters from the inlinequeryresultcacheddocument instance
  await inlinequeryresultcacheddocument.sendGame({ chatId: "Response" });
});
```
...
You can listen for InlineQueryResultCachedDocument events using:

```typescript
// Type-specific handler
bot.onInlineQueryResultCachedDocument(async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
  console.log('Received:', inlinequeryresultcacheddocument);
  // Use fluent methods
  await inlinequeryresultcacheddocument.sendMessage(...);
});

// Generic handler
bot.on('inlinequeryresultcacheddocument', async (data: InlineQueryResultCachedDocument) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InlineQueryResultCachedDocument).
