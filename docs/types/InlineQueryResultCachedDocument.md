...
```typescript
bot.onInlineQueryResultCachedDocument(
  async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
...
```typescript
const inlinequeryresultcacheddocument = new InlineQueryResultCachedDocument(rawData, bot);
await inlinequeryresultcacheddocument.sendChatAction(123, 'example text');
```
...
bot.onInlineQueryResultCachedDocument(
  async (inlinequeryresultcacheddocument: InlineQueryResultCachedDocument) => {
    // Auto-fills parameters from the inlinequeryresultcacheddocument instance
    await inlinequeryresultcacheddocument.sendGame({ gameShortName: 'Response' });
  }
);
```
