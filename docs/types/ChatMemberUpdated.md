...
| oldChatMember           | `ChatMember`     |   Yes    | Previous information about the chat member                                                                                                          |
| newChatMember           | `ChatMember`     |   Yes    | New information about the chat member                                                                                                               |
| inviteLink              | `ChatInviteLink` |    No    | Optional. Chat invite link, which was used by the user to join the chat; for joining by invite link events only.                                    |
| viaJoinRequest          | `boolean`        |    No    | Optional. True, if the user joined the chat after sending a direct join request without using an invite link and being approved by an administrator |
| viaChatFolderInviteLink | `boolean`        |    No    | Optional. True, if the user joined the chat via a chat folder invite link                                                                           |

## Fluent Methods

The `ChatMemberUpdated` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getUpdates({});
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getWebhookInfo({
  url: 'example text',
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getWebhookInfo({ url: 'Response' });
});
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getMe({ text: 'Response' });
});
```
...
| Parameter | Source          | Description                          |
| :-------- | :-------------- | :----------------------------------- |
| `userId`  | `this.from?.id` | Unique identifier of the target user |
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getUserProfilePhotos(123, 123);
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getUserProfilePhotos();
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getFile('example text');
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getFile();
});
```
...
| Parameter | Source          | Description                                                                                                            |
| :-------- | :-------------- | :--------------------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.chat?.id` | Unique identifier for the target chat or username of the target supergroup or channel (in the format @channelusername) |
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getChat();
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getChatAdministrators();
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getChatMemberCount();
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getChatMember();
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getForumTopicIconStickers('example text', 123);
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getForumTopicIconStickers();
});
```
...
| Parameter | Source          | Description                                                                                |
| :-------- | :-------------- | :----------------------------------------------------------------------------------------- |
| `chatId`  | `this.chat?.id` | Unique identifier for the chat or username of the channel (in the format @channelusername) |
| `userId`  | `this.from?.id` | Unique identifier of the target user                                                       |
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getUserChatBoosts();
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getBusinessConnection('example text');
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getBusinessConnection();
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getMyCommands({} as any, 'example text');
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getMyCommands();
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getMyName('example text');
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getMyName();
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getMyDescription('example text');
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getMyDescription();
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getMyShortDescription('example text');
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getMyShortDescription();
});
```
...
| Parameter | Source          | Description                                                                                                 |
| :-------- | :-------------- | :---------------------------------------------------------------------------------------------------------- |
| `chatId`  | `this.chat?.id` | Unique identifier for the target private chat. If not specified, default bot's menu button will be returned |
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getChatMenuButton();
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getMyDefaultAdministratorRights(true);
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getMyDefaultAdministratorRights();
});
```
...
| `userId`  | `this.from?.id` | Required if chat_id is not specified. Unique identifier of the target user who will receive the gift.                                                        |
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getAvailableGifts({
  giftId: 'example text',
  payForUpgrade: true,
});
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getBusinessAccountStarBalance('example text');
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getBusinessAccountStarBalance();
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getStickerSet('example text');
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getStickerSet();
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getCustomEmojiStickers(['example text']);
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getCustomEmojiStickers();
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getMyStarBalance(123, 123);
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getMyStarBalance();
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getStarTransactions(123, 123);
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getStarTransactions();
});
```
...
| Parameter | Source          | Description                                                                           |
| :-------- | :-------------- | :------------------------------------------------------------------------------------ |
| `chatId`  | `this.chat?.id` | Required if inline_message_id is not specified. Unique identifier for the target chat |
| `userId`  | `this.from?.id` | Target user id                                                                        |
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getGameHighScores(123, 'example text');
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getGameHighScores();
});
```
...
You can listen for ChatMemberUpdated events using:

```typescript
// Type-specific handler
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  console.log('Received:', chatmemberupdated);
  // Use fluent methods
  await chatmemberupdated.getUpdates(...);
});

// Generic handler
bot.on('chatmemberupdated', async (data: ChatMemberUpdated) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#ChatMemberUpdated).
