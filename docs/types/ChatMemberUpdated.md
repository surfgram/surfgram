...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getUserProfileAudios(
  123,
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.chat?.id` | Unique identifier for the target chat or username of the target supergroup or channel in the format @username |
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.from?.id` | Unique identifier for the target user |
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getUserPersonalChatMessages(
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.chat?.id` | Unique identifier for the chat or username of the channel in the format @username |
| `userId` | `this.from?.id` | Unique identifier of the target user |
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.from?.id` | User identifier of the managed bot whose token will be returned |
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getManagedBotToken();
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.from?.id` | User identifier of the managed bot whose access settings will be returned |
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getManagedBotAccessSettings();
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `chatId` | `this.chat?.id` | Unique identifier for the target private chat. If not specified, the bot's default menu button will be returned. |
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.from?.id` | Unique identifier of the user |
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getUserGifts({
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getUserGifts({ offset: "Response" });
});
```
...
```typescript
const chatmemberupdated = new ChatMemberUpdated(rawData, bot);
await chatmemberupdated.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onChatMemberUpdated(async (chatmemberupdated: ChatMemberUpdated) => {
  // Auto-fills parameters from the chatmemberupdated instance
  await chatmemberupdated.getChatGifts({ offset: "Response" });
});
```
