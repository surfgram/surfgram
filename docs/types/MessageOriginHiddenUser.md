...
```typescript
const messageoriginhiddenuser = new MessageOriginHiddenUser(rawData, bot);
await messageoriginhiddenuser.sendChatAction(123, 'example text');
```
...
```typescript
const messageoriginhiddenuser = new MessageOriginHiddenUser(rawData, bot);
await messageoriginhiddenuser.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const messageoriginhiddenuser = new MessageOriginHiddenUser(rawData, bot);
await messageoriginhiddenuser.editForumTopic(123, 123);
```
...
```typescript
const messageoriginhiddenuser = new MessageOriginHiddenUser(rawData, bot);
await messageoriginhiddenuser.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const messageoriginhiddenuser = new MessageOriginHiddenUser(rawData, bot);
await messageoriginhiddenuser.editUserStarSubscription('example text', true);
```
...
bot.onMessageOriginHiddenUser(async (messageoriginhiddenuser: MessageOriginHiddenUser) => {
  // Auto-fills parameters from the messageoriginhiddenuser instance
  await messageoriginhiddenuser.sendGame({ gameShortName: 'Response' });
});
```
