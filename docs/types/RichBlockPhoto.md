...
| photo | `PhotoSize[]` | Yes | Available sizes of the photo |
...
The `RichBlockPhoto` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendContact({
  chatId: 123,
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendContact({ chatId: "Response" });
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendChecklist({
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const richblockphoto = new RichBlockPhoto(rawData, bot);
await richblockphoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendInvoice({ chatId: "Response" });
});
```
...
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  // Auto-fills parameters from the richblockphoto instance
  await richblockphoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for RichBlockPhoto events using:

```typescript
// Type-specific handler
bot.onRichBlockPhoto(async (richblockphoto: RichBlockPhoto) => {
  console.log('Received:', richblockphoto);
  // Use fluent methods
  await richblockphoto.sendMessage(...);
});

// Generic handler
bot.on('richblockphoto', async (data: RichBlockPhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#RichBlockPhoto).
