...
| :--- | :--- | :---: | :--- |
| type | `string` | Yes | Scope type, must be chat\_member |
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getUserProfileAudios(
  123,
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.userId` | Unique identifier for the target user |
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getUserPersonalChatMessages(
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.userId` | User identifier of the managed bot whose token will be returned |
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getManagedBotToken();
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.userId` | User identifier of the managed bot whose access settings will be returned |
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getManagedBotAccessSettings();
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.userId` | Unique identifier of the user |
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getUserGifts({
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getUserGifts({ offset: "Response" });
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getChatGifts({ offset: "Response" });
});
```
