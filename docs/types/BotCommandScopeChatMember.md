...
The `BotCommandScopeChatMember` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getUpdates({});
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getWebhookInfo({
  url: 'example text',
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getWebhookInfo({ url: 'Response' });
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getMe({
  text: 'example text',
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getMe({ text: 'Response' });
});
```
...
| Parameter | Source        | Description                          |
| :-------- | :------------ | :----------------------------------- |
| `userId`  | `this.userId` | Unique identifier of the target user |
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getUserProfilePhotos(123, 123);
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getUserProfilePhotos();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getFile('example text');
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getFile();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getChat();
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getChatAdministrators();
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getChatMemberCount();
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getChatMember();
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getForumTopicIconStickers('example text', 123);
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getForumTopicIconStickers();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getUserChatBoosts();
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getBusinessConnection('example text');
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getBusinessConnection();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getMyCommands({} as any, 'example text');
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getMyCommands();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getMyName('example text');
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getMyName();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getMyDescription('example text');
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getMyDescription();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getMyShortDescription('example text');
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getMyShortDescription();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getChatMenuButton();
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getMyDefaultAdministratorRights(true);
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getMyDefaultAdministratorRights();
});
```
...
| Parameter | Source        | Description                                                                                                                                                  |
| :-------- | :------------ | :----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `userId`  | `this.userId` | Required if chat_id is not specified. Unique identifier of the target user who will receive the gift.                                                        |
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getAvailableGifts({
  giftId: 'example text',
  payForUpgrade: true,
});
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getBusinessAccountStarBalance('example text');
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getBusinessAccountStarBalance();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getStickerSet('example text');
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getStickerSet();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getCustomEmojiStickers(['example text']);
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getCustomEmojiStickers();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getMyStarBalance(123, 123);
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getMyStarBalance();
});
```
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getStarTransactions(123, 123);
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getStarTransactions();
});
```
...
| Parameter | Source        | Description                                                                           |
| :-------- | :------------ | :------------------------------------------------------------------------------------ |
| `userId`  | `this.userId` | Target user id                                                                        |
...
```typescript
const botcommandscopechatmember = new BotCommandScopeChatMember(rawData, bot);
await botcommandscopechatmember.getGameHighScores(123, 'example text');
```
...
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  // Auto-fills parameters from the botcommandscopechatmember instance
  await botcommandscopechatmember.getGameHighScores();
});
```
...
You can listen for BotCommandScopeChatMember events using:

```typescript
// Type-specific handler
bot.onBotCommandScopeChatMember(async (botcommandscopechatmember: BotCommandScopeChatMember) => {
  console.log('Received:', botcommandscopechatmember);
  // Use fluent methods
  await botcommandscopechatmember.getUpdates(...);
});

// Generic handler
bot.on('botcommandscopechatmember', async (data: BotCommandScopeChatMember) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#BotCommandScopeChatMember).
