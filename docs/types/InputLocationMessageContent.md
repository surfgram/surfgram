...
The `InputLocationMessageContent` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.forwardMessage({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendContact({
  chatId: 123,
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendPoll({
  chatId: 123,
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendChecklist({
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editChatInviteLink({
  chatId: 123,
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editForumTopic(
  123,
  123,
);
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editGeneralForumTopic(
  123,
  "example text",
);
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editStory({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editUserStarSubscription(
  123,
  "example text",
);
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendGame({
  chatId: 123,
...
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  // Auto-fills parameters from the inputlocationmessagecontent instance
  await inputlocationmessagecontent.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputLocationMessageContent events using:

```typescript
// Type-specific handler
bot.onInputLocationMessageContent(async (inputlocationmessagecontent: InputLocationMessageContent) => {
  console.log('Received:', inputlocationmessagecontent);
  // Use fluent methods
  await inputlocationmessagecontent.sendMessage(...);
});

// Generic handler
bot.on('inputlocationmessagecontent', async (data: InputLocationMessageContent) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputLocationMessageContent).
