...
```typescript
bot.onInputLocationMessageContent(
  async (inputlocationmessagecontent: InputLocationMessageContent) => {
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.sendChatAction(123, 'example text');
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editForumTopic(123, 123);
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const inputlocationmessagecontent = new InputLocationMessageContent(rawData, bot);
await inputlocationmessagecontent.editUserStarSubscription(123, 'example text');
```
...
bot.onInputLocationMessageContent(
  async (inputlocationmessagecontent: InputLocationMessageContent) => {
    // Auto-fills parameters from the inputlocationmessagecontent instance
    await inputlocationmessagecontent.sendGame({ gameShortName: 'Response' });
  }
);
```
