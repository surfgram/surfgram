...
The `InputMediaPhoto` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendContact({
  chatId: 123,
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendPoll({
  chatId: 123,
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendChecklist({
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputmediaphoto = new InputMediaPhoto(rawData, bot);
await inputmediaphoto.sendGame({
  chatId: 123,
...
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  // Auto-fills parameters from the inputmediaphoto instance
  await inputmediaphoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputMediaPhoto events using:

```typescript
// Type-specific handler
bot.onInputMediaPhoto(async (inputmediaphoto: InputMediaPhoto) => {
  console.log('Received:', inputmediaphoto);
  // Use fluent methods
  await inputmediaphoto.sendMessage(...);
});

// Generic handler
bot.on('inputmediaphoto', async (data: InputMediaPhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputMediaPhoto).
