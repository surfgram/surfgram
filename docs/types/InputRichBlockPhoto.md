...
The `InputRichBlockPhoto` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendContact({
  chatId: 123,
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendPoll({
  chatId: 123,
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendChecklist({
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockphoto = new InputRichBlockPhoto(rawData, bot);
await inputrichblockphoto.sendGame({
  chatId: 123,
...
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  // Auto-fills parameters from the inputrichblockphoto instance
  await inputrichblockphoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputRichBlockPhoto events using:

```typescript
// Type-specific handler
bot.onInputRichBlockPhoto(async (inputrichblockphoto: InputRichBlockPhoto) => {
  console.log('Received:', inputrichblockphoto);
  // Use fluent methods
  await inputrichblockphoto.sendMessage(...);
});

// Generic handler
bot.on('inputrichblockphoto', async (data: InputRichBlockPhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputRichBlockPhoto).
