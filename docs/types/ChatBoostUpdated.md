...
| boost | `ChatBoost` |   Yes    | Information about the chat boost |

## Fluent Methods

The `ChatBoostUpdated` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getUpdates({});
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getWebhookInfo({
  url: 'example text',
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getWebhookInfo({ url: 'Response' });
});
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getMe({ text: 'Response' });
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getUserProfilePhotos(123, 123);
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getUserProfilePhotos();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getFile('example text');
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getFile();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getChat();
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getChatAdministrators();
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getChatMemberCount();
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getChatMember(123);
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getChatMember();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getForumTopicIconStickers('example text', 123);
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getForumTopicIconStickers();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getUserChatBoosts(123);
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getUserChatBoosts();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getBusinessConnection('example text');
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getBusinessConnection();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getMyCommands({} as any, 'example text');
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getMyCommands();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getMyName('example text');
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getMyName();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getMyDescription('example text');
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getMyDescription();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getMyShortDescription('example text');
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getMyShortDescription();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getChatMenuButton();
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getMyDefaultAdministratorRights(true);
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getMyDefaultAdministratorRights();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getAvailableGifts({
  giftId: 'example text',
  userId: 123,
});
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getBusinessAccountStarBalance('example text');
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getBusinessAccountStarBalance();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getStickerSet('example text');
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getStickerSet();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getCustomEmojiStickers(['example text']);
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getCustomEmojiStickers();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getMyStarBalance(123, 123);
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getMyStarBalance();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getStarTransactions(123, 123);
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getStarTransactions();
});
```
...
```typescript
const chatboostupdated = new ChatBoostUpdated(rawData, bot);
await chatboostupdated.getGameHighScores(123, 123);
```
...
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  // Auto-fills parameters from the chatboostupdated instance
  await chatboostupdated.getGameHighScores();
});
```
...
You can listen for ChatBoostUpdated events using:

```typescript
// Type-specific handler
bot.onChatBoostUpdated(async (chatboostupdated: ChatBoostUpdated) => {
  console.log('Received:', chatboostupdated);
  // Use fluent methods
  await chatboostupdated.getUpdates(...);
});

// Generic handler
bot.on('chatboostupdated', async (data: ChatBoostUpdated) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#ChatBoostUpdated).
