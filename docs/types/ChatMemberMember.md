...
The `ChatMemberMember` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getUpdates({});
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getWebhookInfo({
  url: 'example text',
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getWebhookInfo({ url: 'Response' });
});
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getMe({ text: 'Response' });
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getUserProfilePhotos(123, 123);
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getUserProfilePhotos();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getFile('example text');
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getFile();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getChat();
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getChatAdministrators();
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getChatMemberCount();
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getChatMember();
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getForumTopicIconStickers('example text', 123);
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getForumTopicIconStickers();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getUserChatBoosts();
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getBusinessConnection('example text');
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getBusinessConnection();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getMyCommands({} as any, 'example text');
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getMyCommands();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getMyName('example text');
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getMyName();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getMyDescription('example text');
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getMyDescription();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getMyShortDescription('example text');
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getMyShortDescription();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getChatMenuButton();
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getMyDefaultAdministratorRights(true);
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getMyDefaultAdministratorRights();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getAvailableGifts({
  giftId: 'example text',
  payForUpgrade: true,
});
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getBusinessAccountStarBalance('example text');
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getBusinessAccountStarBalance();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getStickerSet('example text');
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getStickerSet();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getCustomEmojiStickers(['example text']);
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getCustomEmojiStickers();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getMyStarBalance(123, 123);
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getMyStarBalance();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getStarTransactions(123, 123);
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getStarTransactions();
});
```
...
```typescript
const chatmembermember = new ChatMemberMember(rawData, bot);
await chatmembermember.getGameHighScores(123, 'example text');
```
...
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  // Auto-fills parameters from the chatmembermember instance
  await chatmembermember.getGameHighScores();
});
```
...
You can listen for ChatMemberMember events using:

```typescript
// Type-specific handler
bot.onChatMemberMember(async (chatmembermember: ChatMemberMember) => {
  console.log('Received:', chatmembermember);
  // Use fluent methods
  await chatmembermember.getUpdates(...);
});

// Generic handler
bot.on('chatmembermember', async (data: ChatMemberMember) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#ChatMemberMember).
