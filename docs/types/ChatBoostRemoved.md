...
| boostId    | `string`          |   Yes    | Unique identifier of the boost                              |
| removeDate | `number`          |   Yes    | Point in time \(Unix timestamp\) when the boost was removed |
| source     | `ChatBoostSource` |   Yes    | Source of the removed boost                                 |

## Fluent Methods

The `ChatBoostRemoved` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getUpdates({});
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getWebhookInfo({
  url: 'example text',
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getWebhookInfo({ url: 'Response' });
});
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getMe({ text: 'Response' });
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getUserProfilePhotos(123, 123);
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getUserProfilePhotos();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getFile('example text');
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getFile();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getChat();
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getChatAdministrators();
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getChatMemberCount();
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getChatMember(123);
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getChatMember();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getForumTopicIconStickers('example text', 123);
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getForumTopicIconStickers();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getUserChatBoosts(123);
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getUserChatBoosts();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getBusinessConnection('example text');
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getBusinessConnection();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getMyCommands({} as any, 'example text');
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getMyCommands();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getMyName('example text');
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getMyName();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getMyDescription('example text');
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getMyDescription();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getMyShortDescription('example text');
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getMyShortDescription();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getChatMenuButton();
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getMyDefaultAdministratorRights(true);
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getMyDefaultAdministratorRights();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getAvailableGifts({
  giftId: 'example text',
  userId: 123,
});
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getBusinessAccountStarBalance('example text');
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getBusinessAccountStarBalance();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getStickerSet('example text');
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getStickerSet();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getCustomEmojiStickers(['example text']);
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getCustomEmojiStickers();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getMyStarBalance(123, 123);
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getMyStarBalance();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getStarTransactions(123, 123);
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getStarTransactions();
});
```
...
```typescript
const chatboostremoved = new ChatBoostRemoved(rawData, bot);
await chatboostremoved.getGameHighScores(123, 123);
```
...
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  // Auto-fills parameters from the chatboostremoved instance
  await chatboostremoved.getGameHighScores();
});
```
...
You can listen for ChatBoostRemoved events using:

```typescript
// Type-specific handler
bot.onChatBoostRemoved(async (chatboostremoved: ChatBoostRemoved) => {
  console.log('Received:', chatboostremoved);
  // Use fluent methods
  await chatboostremoved.getUpdates(...);
});

// Generic handler
bot.on('chatboostremoved', async (data: ChatBoostRemoved) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#ChatBoostRemoved).
