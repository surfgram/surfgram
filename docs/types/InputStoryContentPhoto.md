...
The `InputStoryContentPhoto` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendContact({
  chatId: 123,
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendPoll({
  chatId: 123,
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendChecklist({
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputstorycontentphoto = new InputStoryContentPhoto(rawData, bot);
await inputstorycontentphoto.sendGame({
  chatId: 123,
...
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  // Auto-fills parameters from the inputstorycontentphoto instance
  await inputstorycontentphoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputStoryContentPhoto events using:

```typescript
// Type-specific handler
bot.onInputStoryContentPhoto(async (inputstorycontentphoto: InputStoryContentPhoto) => {
  console.log('Received:', inputstorycontentphoto);
  // Use fluent methods
  await inputstorycontentphoto.sendMessage(...);
});

// Generic handler
bot.on('inputstorycontentphoto', async (data: InputStoryContentPhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputStoryContentPhoto).
