...
| :----- | :------- | :------: | :------------------------------------ |
| source | `string` |   Yes    | Source of the boost, always “premium” |
| user   | `User`   |   Yes    | User that boosted the chat            |

## Fluent Methods

The `ChatBoostSourcePremium` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getUpdates({});
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getWebhookInfo({
  url: 'example text',
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getWebhookInfo({ url: 'Response' });
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getMe({
  text: 'example text',
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getMe({ text: 'Response' });
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getUserProfilePhotos(123, 123);
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getUserProfilePhotos();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getFile('example text');
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getFile();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getChat();
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getChatAdministrators();
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getChatMemberCount();
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getChatMember();
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getForumTopicIconStickers('example text', 123);
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getForumTopicIconStickers();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getUserChatBoosts();
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getBusinessConnection('example text');
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getBusinessConnection();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getMyCommands({} as any, 'example text');
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getMyCommands();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getMyName('example text');
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getMyName();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getMyDescription('example text');
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getMyDescription();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getMyShortDescription('example text');
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getMyShortDescription();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getChatMenuButton();
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getMyDefaultAdministratorRights(true);
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getMyDefaultAdministratorRights();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getAvailableGifts({
  giftId: 'example text',
  payForUpgrade: true,
});
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getBusinessAccountStarBalance('example text');
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getBusinessAccountStarBalance();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getStickerSet('example text');
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getStickerSet();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getCustomEmojiStickers(['example text']);
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getCustomEmojiStickers();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getMyStarBalance(123, 123);
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getMyStarBalance();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getStarTransactions(123, 123);
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getStarTransactions();
});
```
...
```typescript
const chatboostsourcepremium = new ChatBoostSourcePremium(rawData, bot);
await chatboostsourcepremium.getGameHighScores(123, 'example text');
```
...
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  // Auto-fills parameters from the chatboostsourcepremium instance
  await chatboostsourcepremium.getGameHighScores();
});
```
...
You can listen for ChatBoostSourcePremium events using:

```typescript
// Type-specific handler
bot.onChatBoostSourcePremium(async (chatboostsourcepremium: ChatBoostSourcePremium) => {
  console.log('Received:', chatboostsourcepremium);
  // Use fluent methods
  await chatboostsourcepremium.getUpdates(...);
});

// Generic handler
bot.on('chatboostsourcepremium', async (data: ChatBoostSourcePremium) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#ChatBoostSourcePremium).
