...
| photoUrl | `string` | Yes | A valid URL of the photo. Photo must be in JPEG format. Photo size must not exceed 5MB. |
| thumbnailUrl | `string` | Yes | URL of the thumbnail for the photo |
| photoWidth | `number` | No | Optional. Width of the photo |
| photoHeight | `number` | No | Optional. Height of the photo |
...
The `InlineQueryResultPhoto` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendContact({
  chatId: 123,
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendPoll({
  chatId: 123,
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendChecklist({
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultphoto = new InlineQueryResultPhoto(rawData, bot);
await inlinequeryresultphoto.sendGame({
  chatId: 123,
...
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  // Auto-fills parameters from the inlinequeryresultphoto instance
  await inlinequeryresultphoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for InlineQueryResultPhoto events using:

```typescript
// Type-specific handler
bot.onInlineQueryResultPhoto(async (inlinequeryresultphoto: InlineQueryResultPhoto) => {
  console.log('Received:', inlinequeryresultphoto);
  // Use fluent methods
  await inlinequeryresultphoto.sendMessage(...);
});

// Generic handler
bot.on('inlinequeryresultphoto', async (data: InlineQueryResultPhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InlineQueryResultPhoto).
