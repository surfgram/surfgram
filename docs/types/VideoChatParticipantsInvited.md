...
```typescript
bot.onVideoChatParticipantsInvited(
  async (videochatparticipantsinvited: VideoChatParticipantsInvited) => {
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.sendChatAction('example text', 'example text');
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getUserProfilePhotos(123, 123);
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getFile('example text');
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getForumTopicIconStickers('example text', 123);
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getBusinessConnection('example text');
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getMyCommands({} as any, 'example text');
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getMyName('example text');
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getMyDescription('example text');
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getMyShortDescription('example text');
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getMyDefaultAdministratorRights(true);
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getBusinessAccountStarBalance('example text');
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getStickerSet('example text');
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getCustomEmojiStickers(['example text']);
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getMyStarBalance(123, 123);
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getStarTransactions(123, 123);
```
...
```typescript
const videochatparticipantsinvited = new VideoChatParticipantsInvited(rawData, bot);
await videochatparticipantsinvited.getGameHighScores(123, 'example text');
```
