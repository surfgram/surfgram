...
The `ChatMemberLeft` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getUpdates({});
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getWebhookInfo({
  url: 'example text',
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getWebhookInfo({ url: 'Response' });
});
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getMe({ text: 'Response' });
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getUserProfilePhotos(123, 123);
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getUserProfilePhotos();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getFile('example text');
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getChatAdministrators();
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getChatMemberCount();
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getChatMember();
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getForumTopicIconStickers('example text', 123);
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getForumTopicIconStickers();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getUserChatBoosts();
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getBusinessConnection('example text');
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getBusinessConnection();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getMyCommands({} as any, 'example text');
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getMyCommands();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getMyName('example text');
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getMyName();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getMyDescription('example text');
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getMyDescription();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getMyShortDescription('example text');
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getMyShortDescription();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getChatMenuButton();
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getMyDefaultAdministratorRights(true);
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getMyDefaultAdministratorRights();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getAvailableGifts({
  giftId: 'example text',
  payForUpgrade: true,
});
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getBusinessAccountStarBalance('example text');
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getBusinessAccountStarBalance();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getStickerSet('example text');
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getStickerSet();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getCustomEmojiStickers(['example text']);
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getCustomEmojiStickers();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getMyStarBalance(123, 123);
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getMyStarBalance();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getStarTransactions(123, 123);
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getStarTransactions();
});
```
...
```typescript
const chatmemberleft = new ChatMemberLeft(rawData, bot);
await chatmemberleft.getGameHighScores(123, 'example text');
```
...
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  // Auto-fills parameters from the chatmemberleft instance
  await chatmemberleft.getGameHighScores();
});
```
...
You can listen for ChatMemberLeft events using:

```typescript
// Type-specific handler
bot.onChatMemberLeft(async (chatmemberleft: ChatMemberLeft) => {
  console.log('Received:', chatmemberleft);
  // Use fluent methods
  await chatmemberleft.getUpdates(...);
});

// Generic handler
bot.on('chatmemberleft', async (data: ChatMemberLeft) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#ChatMemberLeft).
