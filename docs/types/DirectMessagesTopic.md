...
```typescript
const directmessagestopic = new DirectMessagesTopic(rawData, bot);
await directmessagestopic.sendChatAction(123, 'example text');
```
...
```typescript
const directmessagestopic = new DirectMessagesTopic(rawData, bot);
await directmessagestopic.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const directmessagestopic = new DirectMessagesTopic(rawData, bot);
await directmessagestopic.editForumTopic(123, 123);
```
...
```typescript
const directmessagestopic = new DirectMessagesTopic(rawData, bot);
await directmessagestopic.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const directmessagestopic = new DirectMessagesTopic(rawData, bot);
await directmessagestopic.editUserStarSubscription('example text', true);
```
...
bot.onDirectMessagesTopic(async (directmessagestopic: DirectMessagesTopic) => {
  // Auto-fills parameters from the directmessagestopic instance
  await directmessagestopic.sendGame({ gameShortName: 'Response' });
});
```
