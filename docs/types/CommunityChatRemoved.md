...
The `CommunityChatRemoved` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onCommunityChatRemoved(async (communitychatremoved: CommunityChatRemoved) => {
  // Auto-fills parameters from the communitychatremoved instance
  await communitychatremoved.getUpdates({});
});
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getWebhookInfo({
  url: "example text",
...
bot.onCommunityChatRemoved(async (communitychatremoved: CommunityChatRemoved) => {
  // Auto-fills parameters from the communitychatremoved instance
  await communitychatremoved.getWebhookInfo({ url: "Response" });
});
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getMe({
  text: "example text",
...
bot.onCommunityChatRemoved(async (communitychatremoved: CommunityChatRemoved) => {
  // Auto-fills parameters from the communitychatremoved instance
  await communitychatremoved.getMe({ text: "Response" });
});
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getUserProfilePhotos(
  123,
  123,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getUserProfileAudios(
  123,
  123,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getFile(
  "example text",
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getChat();
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getChatAdministrators(
  true,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getChatMemberCount();
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getChatMember(
  123,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getUserPersonalChatMessages(
  123,
  123,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getForumTopicIconStickers(
  "example text",
  123,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getUserChatBoosts(
  123,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getBusinessConnection(
  "example text",
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getManagedBotToken(
  123,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getManagedBotAccessSettings(
  123,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getMyCommands(
  {} as any,
  "example text",
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getMyName(
  "example text",
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getMyDescription(
  "example text",
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getMyShortDescription(
  "example text",
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getChatMenuButton();
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getMyDefaultAdministratorRights(
  true,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getAvailableGifts({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onCommunityChatRemoved(async (communitychatremoved: CommunityChatRemoved) => {
  // Auto-fills parameters from the communitychatremoved instance
  await communitychatremoved.getAvailableGifts({ giftId: "Response" });
});
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getBusinessAccountStarBalance(
  "example text",
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getBusinessAccountGifts({
  businessConnectionId: "example text",
  excludeUnsaved: true,
});
```
...
bot.onCommunityChatRemoved(async (communitychatremoved: CommunityChatRemoved) => {
  // Auto-fills parameters from the communitychatremoved instance
  await communitychatremoved.getBusinessAccountGifts({ businessConnectionId: "Response" });
});
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getUserGifts({
  userId: 123,
...
bot.onCommunityChatRemoved(async (communitychatremoved: CommunityChatRemoved) => {
  // Auto-fills parameters from the communitychatremoved instance
  await communitychatremoved.getUserGifts({ offset: "Response" });
});
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onCommunityChatRemoved(async (communitychatremoved: CommunityChatRemoved) => {
  // Auto-fills parameters from the communitychatremoved instance
  await communitychatremoved.getChatGifts({ offset: "Response" });
});
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getStickerSet(
  "example text",
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getCustomEmojiStickers(
  ["example text"],
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getMyStarBalance(
  123,
  123,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getStarTransactions(
  123,
  123,
);
```
...
```typescript
const communitychatremoved = new CommunityChatRemoved(rawData, bot);
await communitychatremoved.getGameHighScores(
  123,
  123,
);
```
...
You can listen for CommunityChatRemoved events using:

```typescript
// Type-specific handler
bot.onCommunityChatRemoved(async (communitychatremoved: CommunityChatRemoved) => {
  console.log('Received:', communitychatremoved);
  // Use fluent methods
  await communitychatremoved.getUpdates(...);
});

// Generic handler
bot.on('communitychatremoved', async (data: CommunityChatRemoved) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#CommunityChatRemoved).
