...
| animation | `string` | Yes | The animated profile photo. Profile photos can't be reused and can only be uploaded as a new file, so you can pass “attach://&lt;file\_attach\_name&gt;” if the photo was uploaded using multipart/form-data under &lt;file\_attach\_name&gt;. More information on Sending Files » |
| mainFrameTimestamp | `number` | No | Optional. Timestamp in seconds of the frame that will be used as the static profile photo. Defaults to 0.0. |

## Fluent Methods

The `InputProfilePhotoAnimated` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendContact({
  chatId: 123,
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendPoll({
  chatId: 123,
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendChecklist({
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephotoanimated = new InputProfilePhotoAnimated(rawData, bot);
await inputprofilephotoanimated.sendGame({
  chatId: 123,
...
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  // Auto-fills parameters from the inputprofilephotoanimated instance
  await inputprofilephotoanimated.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputProfilePhotoAnimated events using:

```typescript
// Type-specific handler
bot.onInputProfilePhotoAnimated(async (inputprofilephotoanimated: InputProfilePhotoAnimated) => {
  console.log('Received:', inputprofilephotoanimated);
  // Use fluent methods
  await inputprofilephotoanimated.sendMessage(...);
});

// Generic handler
bot.on('inputprofilephotoanimated', async (data: InputProfilePhotoAnimated) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputProfilePhotoAnimated).
