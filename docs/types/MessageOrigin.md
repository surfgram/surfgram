...
```typescript
const messageorigin = new MessageOrigin(rawData, bot);
await messageorigin.sendChatAction(123, 'example text');
```
...
```typescript
const messageorigin = new MessageOrigin(rawData, bot);
await messageorigin.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const messageorigin = new MessageOrigin(rawData, bot);
await messageorigin.editForumTopic(123, 123);
```
...
```typescript
const messageorigin = new MessageOrigin(rawData, bot);
await messageorigin.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const messageorigin = new MessageOrigin(rawData, bot);
await messageorigin.editUserStarSubscription('example text', true);
```
...
bot.onMessageOrigin(async (messageorigin: MessageOrigin) => {
  // Auto-fills parameters from the messageorigin instance
  await messageorigin.sendGame({ gameShortName: 'Response' });
});
```
