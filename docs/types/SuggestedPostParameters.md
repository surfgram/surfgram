...
```typescript
const suggestedpostparameters = new SuggestedPostParameters(rawData, bot);
await suggestedpostparameters.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onSuggestedPostParameters(async (suggestedpostparameters: SuggestedPostParameters) => {
  // Auto-fills parameters from the suggestedpostparameters instance
  await suggestedpostparameters.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const suggestedpostparameters = new SuggestedPostParameters(rawData, bot);
await suggestedpostparameters.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onSuggestedPostParameters(async (suggestedpostparameters: SuggestedPostParameters) => {
  // Auto-fills parameters from the suggestedpostparameters instance
  await suggestedpostparameters.sendRichMessage({ chatId: "Response" });
});
```
