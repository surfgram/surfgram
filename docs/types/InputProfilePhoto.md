...
The `InputProfilePhoto` class has the following fluent methods that automatically inject contextual parameters:
...
await inputprofilephoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  ...
  await inputprofilephoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendContact({
  chatId: 123,
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendPoll({
  chatId: 123,
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendChecklist({
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.setBusinessAccountProfilePhoto(
  "example text",
  {} as any,
);
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputprofilephoto = new InputProfilePhoto(rawData, bot);
await inputprofilephoto.sendGame({
  chatId: 123,
...
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  // Auto-fills parameters from the inputprofilephoto instance
  await inputprofilephoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputProfilePhoto events using:

```typescript
// Type-specific handler
bot.onInputProfilePhoto(async (inputprofilephoto: InputProfilePhoto) => {
  console.log('Received:', inputprofilephoto);
  // Use fluent methods
  await inputprofilephoto.sendMessage(...);
});

// Generic handler
bot.on('inputprofilephoto', async (data: InputProfilePhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputProfilePhoto).
