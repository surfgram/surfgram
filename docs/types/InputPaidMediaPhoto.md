...
The `InputPaidMediaPhoto` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendContact({
  chatId: 123,
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendPoll({
  chatId: 123,
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendChecklist({
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmediaphoto = new InputPaidMediaPhoto(rawData, bot);
await inputpaidmediaphoto.sendGame({
  chatId: 123,
...
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  // Auto-fills parameters from the inputpaidmediaphoto instance
  await inputpaidmediaphoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputPaidMediaPhoto events using:

```typescript
// Type-specific handler
bot.onInputPaidMediaPhoto(async (inputpaidmediaphoto: InputPaidMediaPhoto) => {
  console.log('Received:', inputpaidmediaphoto);
  // Use fluent methods
  await inputpaidmediaphoto.sendMessage(...);
});

// Generic handler
bot.on('inputpaidmediaphoto', async (data: InputPaidMediaPhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputPaidMediaPhoto).
