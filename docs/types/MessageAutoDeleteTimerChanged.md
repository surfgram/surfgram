...
```typescript
bot.onMessageAutoDeleteTimerChanged(
  async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendChatAction(123, 'example text');
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editForumTopic(123, 123);
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editUserStarSubscription(123, 'example text');
```
...
bot.onMessageAutoDeleteTimerChanged(
  async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
    // Auto-fills parameters from the messageautodeletetimerchanged instance
    await messageautodeletetimerchanged.sendGame({ gameShortName: 'Response' });
  }
);
```
