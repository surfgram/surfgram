...
| :--- | :--- | :---: | :--- |
| messageAutoDeleteTime | `number` | Yes | New auto-delete time for messages in the chat; in seconds |

## Fluent Methods

The `MessageAutoDeleteTimerChanged` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendMessage({ chatId: "Response" });
});
```
...
| :--- | :--- | :--- |
| `messageId` | `this.messageAutoDeleteTime?.id` | Message identifier in the chat specified in from_chat_id |
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.forwardMessage({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendContact({
  chatId: 123,
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendContact({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendPoll({
  chatId: 123,
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendChecklist({
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendDice({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editChatInviteLink({
  chatId: 123,
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editForumTopic(
  123,
  123,
);
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editGeneralForumTopic(
  123,
  "example text",
);
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendGift({ giftId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editStory({ businessConnectionId: "Response" });
});
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `messageId` | `this.messageAutoDeleteTime?.id` | Required if inline_message_id is not specified. Identifier of the message to edit. |
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `messageId` | `this.messageAutoDeleteTime?.id` | Unique identifier for the target message |
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.editUserStarSubscription(
  123,
  "example text",
);
```
...
```typescript
const messageautodeletetimerchanged = new MessageAutoDeleteTimerChanged(rawData, bot);
await messageautodeletetimerchanged.sendGame({
  chatId: 123,
...
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  // Auto-fills parameters from the messageautodeletetimerchanged instance
  await messageautodeletetimerchanged.sendGame({ chatId: "Response" });
});
```
...
You can listen for MessageAutoDeleteTimerChanged events using:

```typescript
// Type-specific handler
bot.onMessageAutoDeleteTimerChanged(async (messageautodeletetimerchanged: MessageAutoDeleteTimerChanged) => {
  console.log('Received:', messageautodeletetimerchanged);
  // Use fluent methods
  await messageautodeletetimerchanged.sendMessage(...);
});

// Generic handler
bot.on('messageautodeletetimerchanged', async (data: MessageAutoDeleteTimerChanged) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#MessageAutoDeleteTimerChanged).
