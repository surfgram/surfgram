...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.sendChatAction('example text', 'example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getUserProfilePhotos(123, 123);
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getFile('example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.editChatSubscriptionInviteLink('example text', 'example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getChatMember(123);
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getForumTopicIconStickers('example text', 123);
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.editForumTopic(123, 'example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.editGeneralForumTopic('example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getUserChatBoosts(123);
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getBusinessConnection('example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getMyCommands({} as any, 'example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getMyName('example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getMyDescription('example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getMyShortDescription('example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getMyDefaultAdministratorRights(true);
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getBusinessAccountStarBalance('example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getStickerSet('example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getCustomEmojiStickers(['example text']);
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getMyStarBalance(123, 123);
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getStarTransactions(123, 123);
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.editUserStarSubscription(123, 'example text');
```
...
```typescript
const messageoriginchat = new MessageOriginChat(rawData, bot);
await messageoriginchat.getGameHighScores(123, 'example text');
```
