...
| :--- | :--- | :---: | :--- |
| type | `string` | Yes | Type of the paid media, always “live\_photo” |
| livePhoto | `LivePhoto` | Yes | The photo |

## Fluent Methods

The `PaidMediaLivePhoto` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendContact({
  chatId: 123,
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendContact({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendPoll({
  chatId: 123,
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendChecklist({
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const paidmedialivephoto = new PaidMediaLivePhoto(rawData, bot);
await paidmedialivephoto.sendGame({
  chatId: 123,
...
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  // Auto-fills parameters from the paidmedialivephoto instance
  await paidmedialivephoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for PaidMediaLivePhoto events using:

```typescript
// Type-specific handler
bot.onPaidMediaLivePhoto(async (paidmedialivephoto: PaidMediaLivePhoto) => {
  console.log('Received:', paidmedialivephoto);
  // Use fluent methods
  await paidmedialivephoto.sendMessage(...);
});

// Generic handler
bot.on('paidmedialivephoto', async (data: PaidMediaLivePhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#PaidMediaLivePhoto).
