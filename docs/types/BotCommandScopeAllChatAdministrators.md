...
| :--- | :--- | :---: | :--- |
| type | `string` | Yes | Scope type, must be all\_chat\_administrators |
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getUserProfileAudios(
  123,
  123,
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getUserPersonalChatMessages(
  123,
  123,
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getManagedBotToken(
  123,
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getManagedBotAccessSettings(
  123,
);
```
...
bot.onBotCommandScopeAllChatAdministrators(async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
  // Auto-fills parameters from the botcommandscopeallchatadministrators instance
  await botcommandscopeallchatadministrators.getBusinessAccountGifts({ businessConnectionId: "Response" });
});
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getUserGifts({
  userId: 123,
...
bot.onBotCommandScopeAllChatAdministrators(async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
  // Auto-fills parameters from the botcommandscopeallchatadministrators instance
  await botcommandscopeallchatadministrators.getUserGifts({ offset: "Response" });
});
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onBotCommandScopeAllChatAdministrators(async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
  // Auto-fills parameters from the botcommandscopeallchatadministrators instance
  await botcommandscopeallchatadministrators.getChatGifts({ offset: "Response" });
});
```
