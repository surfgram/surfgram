...
| :--- | :------- | :------: | :------------------------------------------ |
| type | `string` |   Yes    | Scope type, must be all_chat_administrators |

## Fluent Methods

The `BotCommandScopeAllChatAdministrators` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getUpdates({});
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getWebhookInfo({
  url: 'example text',
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getWebhookInfo({ url: 'Response' });
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getMe({
  text: 'example text',
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getMe({ text: 'Response' });
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getUserProfilePhotos(123, 123);
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getUserProfilePhotos();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getFile('example text');
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getFile();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getChat();
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getChatAdministrators();
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getChatMemberCount();
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getChatMember(123);
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getChatMember();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getForumTopicIconStickers('example text', 123);
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getForumTopicIconStickers();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getUserChatBoosts(123);
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getUserChatBoosts();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getBusinessConnection('example text');
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getBusinessConnection();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getMyCommands({} as any, 'example text');
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getMyCommands();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getMyName('example text');
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getMyName();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getMyDescription('example text');
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getMyDescription();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getMyShortDescription('example text');
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getMyShortDescription();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getChatMenuButton();
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getMyDefaultAdministratorRights(true);
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getMyDefaultAdministratorRights();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getAvailableGifts({
  giftId: 'example text',
  userId: 123,
});
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getAvailableGifts({ giftId: 'Response' });
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getBusinessAccountStarBalance('example text');
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getBusinessAccountStarBalance();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getStickerSet('example text');
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getStickerSet();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getCustomEmojiStickers(['example text']);
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getCustomEmojiStickers();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getMyStarBalance(123, 123);
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getMyStarBalance();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getStarTransactions(123, 123);
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getStarTransactions();
  }
);
```
...
```typescript
const botcommandscopeallchatadministrators = new BotCommandScopeAllChatAdministrators(rawData, bot);
await botcommandscopeallchatadministrators.getGameHighScores(123, 123);
```
...
bot.onBotCommandScopeAllChatAdministrators(
  async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
    // Auto-fills parameters from the botcommandscopeallchatadministrators instance
    await botcommandscopeallchatadministrators.getGameHighScores();
  }
);
```
...
You can listen for BotCommandScopeAllChatAdministrators events using:

```typescript
// Type-specific handler
bot.onBotCommandScopeAllChatAdministrators(async (botcommandscopeallchatadministrators: BotCommandScopeAllChatAdministrators) => {
  console.log('Received:', botcommandscopeallchatadministrators);
  // Use fluent methods
  await botcommandscopeallchatadministrators.getUpdates(...);
});

// Generic handler
bot.on('botcommandscopeallchatadministrators', async (data: BotCommandScopeAllChatAdministrators) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#BotCommandScopeAllChatAdministrators).
