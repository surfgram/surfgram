...
| documentUrl | `string` | Yes | A valid URL for the file |
| mimeType | `string` | Yes | MIME type of the content of the file, either “application/pdf” or “application/zip” |
...
| thumbnailUrl | `string` | No | Optional. URL of the thumbnail \(JPEG only\) for the file |
| thumbnailWidth | `number` | No | Optional. Thumbnail width |
| thumbnailHeight | `number` | No | Optional. Thumbnail height |

## Fluent Methods

The `InlineQueryResultDocument` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendContact({
  chatId: 123,
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendPoll({
  chatId: 123,
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendChecklist({
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultdocument = new InlineQueryResultDocument(rawData, bot);
await inlinequeryresultdocument.sendGame({
  chatId: 123,
...
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  // Auto-fills parameters from the inlinequeryresultdocument instance
  await inlinequeryresultdocument.sendGame({ chatId: "Response" });
});
```
...
You can listen for InlineQueryResultDocument events using:

```typescript
// Type-specific handler
bot.onInlineQueryResultDocument(async (inlinequeryresultdocument: InlineQueryResultDocument) => {
  console.log('Received:', inlinequeryresultdocument);
  // Use fluent methods
  await inlinequeryresultdocument.sendMessage(...);
});

// Generic handler
bot.on('inlinequeryresultdocument', async (data: InlineQueryResultDocument) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InlineQueryResultDocument).
