...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendChatAction('example text', 'example text');
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editChatSubscriptionInviteLink('example text', 'example text');
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editForumTopic(123, 'example text');
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editGeneralForumTopic('example text');
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editUserStarSubscription(123, 'example text');
```
