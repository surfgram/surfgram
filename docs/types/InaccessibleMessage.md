...
The `InaccessibleMessage` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendMessage({
  text: "example text",
...
```typescript
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendMessage({ text: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.forwardMessage({
  messageThreadId: 123,
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.forwardMessage({ messageEffectId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.forwardMessages({
  messageIds: [123],
  messageThreadId: 123,
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendPhoto({
  photo: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendPhoto({ photo: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendLivePhoto({
  livePhoto: {} as any,
  photo: {} as any,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendLivePhoto({ livePhoto: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendAudio({
  audio: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendAudio({ audio: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendDocument({
  document: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendDocument({ document: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendVideo({
  video: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendVideo({ video: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendAnimation({
  animation: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendAnimation({ animation: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendVoice({
  voice: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendVoice({ voice: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendVideoNote({
  videoNote: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendVideoNote({ videoNote: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendPaidMedia({
  starCount: 123,
  media: [{} as any],
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendPaidMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendMediaGroup({
  media: [{} as any],
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendMediaGroup({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendVenue({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendVenue({ title: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendContact({
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendContact({ phoneNumber: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendPoll({
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendPoll({ question: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendChecklist({
  businessConnectionId: "example text",
  checklist: {} as any,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendDice({
  businessConnectionId: "example text",
  messageThreadId: 123,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendDice({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendMessageDraft({
  draftId: 123,
  messageThreadId: 123,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendChatAction(
  "example text",
  "example text",
);
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editChatInviteLink({
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.editChatInviteLink({ inviteLink: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editChatSubscriptionInviteLink(
  "example text",
  "example text",
);
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendChatJoinRequestWebApp(
  "example text",
);
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editForumTopic(
  123,
  "example text",
);
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editGeneralForumTopic(
  "example text",
);
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.editStory({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editMessageText({
  businessConnectionId: "example text",
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editMessageCaption({
  businessConnectionId: "example text",
  inlineMessageId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editMessageChecklist({
  businessConnectionId: "example text",
  checklist: {} as any,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editMessageReplyMarkup({
  businessConnectionId: "example text",
  inlineMessageId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editEphemeralMessageText({
  receiverUserId: 123,
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.editEphemeralMessageText({ text: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editEphemeralMessageMedia({
  receiverUserId: 123,
  ephemeralMessageId: 123,
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editEphemeralMessageCaption({
  receiverUserId: 123,
  ephemeralMessageId: 123,
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.editEphemeralMessageCaption({ caption: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendSticker({
  sticker: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendSticker({ sticker: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendRichMessage({
  richMessage: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendRichMessage({ businessConnectionId: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendRichMessageDraft(
  123,
  {} as any,
);
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendInvoice({
  title: "example text",
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendInvoice({ title: "Response" });
});
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.editUserStarSubscription(
  123,
  "example text",
);
```
...
```typescript
const inaccessiblemessage = new InaccessibleMessage(rawData, bot);
await inaccessiblemessage.sendGame({
...
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  // Auto-fills parameters from the inaccessiblemessage instance
  await inaccessiblemessage.sendGame({ gameShortName: "Response" });
});
```
...
You can listen for InaccessibleMessage events using:

```typescript
// Type-specific handler
bot.onInaccessibleMessage(async (inaccessiblemessage: InaccessibleMessage) => {
  console.log('Received:', inaccessiblemessage);
  // Use fluent methods
  await inaccessiblemessage.sendMessage(...);
});

// Generic handler
bot.on('inaccessiblemessage', async (data: InaccessibleMessage) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InaccessibleMessage).
