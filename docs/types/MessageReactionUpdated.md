...
```typescript
const messagereactionupdated = new MessageReactionUpdated(rawData, bot);
await messagereactionupdated.sendChatAction('example text', 'example text');
```
...
```typescript
const messagereactionupdated = new MessageReactionUpdated(rawData, bot);
await messagereactionupdated.editChatSubscriptionInviteLink('example text', 'example text');
```
...
```typescript
const messagereactionupdated = new MessageReactionUpdated(rawData, bot);
await messagereactionupdated.editForumTopic(123, 'example text');
```
...
```typescript
const messagereactionupdated = new MessageReactionUpdated(rawData, bot);
await messagereactionupdated.editGeneralForumTopic('example text');
```
...
```typescript
const messagereactionupdated = new MessageReactionUpdated(rawData, bot);
await messagereactionupdated.editUserStarSubscription('example text', true);
```
