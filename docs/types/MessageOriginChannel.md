...
```typescript
const messageoriginchannel = new MessageOriginChannel(rawData, bot);
await messageoriginchannel.sendChatAction('example text', 'example text');
```
...
```typescript
const messageoriginchannel = new MessageOriginChannel(rawData, bot);
await messageoriginchannel.editChatSubscriptionInviteLink('example text', 'example text');
```
...
```typescript
const messageoriginchannel = new MessageOriginChannel(rawData, bot);
await messageoriginchannel.editForumTopic(123, 'example text');
```
...
```typescript
const messageoriginchannel = new MessageOriginChannel(rawData, bot);
await messageoriginchannel.editGeneralForumTopic('example text');
```
...
```typescript
const messageoriginchannel = new MessageOriginChannel(rawData, bot);
await messageoriginchannel.editUserStarSubscription(123, 'example text');
```
