...
| :--- | :--- | :---: | :--- |
| type | `string` | Yes | Type of the background, always “chat\_theme” |
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getUserProfileAudios(
  123,
  123,
);
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getUserPersonalChatMessages(
  123,
  123,
);
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getManagedBotToken(
  123,
);
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getManagedBotAccessSettings(
  123,
);
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getUserGifts({
  userId: 123,
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getUserGifts({ offset: "Response" });
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getChatGifts({ offset: "Response" });
});
```
