...
| :-------- | :------- | :------: | :------------------------------------------------ |
| type      | `string` |   Yes    | Type of the background, always “chat_theme”       |
| themeName | `string` |   Yes    | Name of the chat theme, which is usually an emoji |

## Fluent Methods

The `BackgroundTypeChatTheme` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getUpdates({});
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getWebhookInfo({
  url: 'example text',
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getWebhookInfo({ url: 'Response' });
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getMe({
  text: 'example text',
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getMe({ text: 'Response' });
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getUserProfilePhotos(123, 123);
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getUserProfilePhotos();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getFile('example text');
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getFile();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getChat();
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getChatAdministrators();
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getChatMemberCount();
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getChatMember(123);
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getChatMember();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getForumTopicIconStickers('example text', 123);
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getForumTopicIconStickers();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getUserChatBoosts(123);
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getUserChatBoosts();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getBusinessConnection('example text');
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getBusinessConnection();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getMyCommands({} as any, 'example text');
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getMyCommands();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getMyName('example text');
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getMyName();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getMyDescription('example text');
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getMyDescription();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getMyShortDescription('example text');
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getMyShortDescription();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getChatMenuButton();
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getMyDefaultAdministratorRights(true);
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getMyDefaultAdministratorRights();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getAvailableGifts({
  giftId: 'example text',
  userId: 123,
});
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getBusinessAccountStarBalance('example text');
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getBusinessAccountStarBalance();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getStickerSet('example text');
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getStickerSet();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getCustomEmojiStickers(['example text']);
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getCustomEmojiStickers();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getMyStarBalance(123, 123);
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getMyStarBalance();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getStarTransactions(123, 123);
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getStarTransactions();
});
```
...
```typescript
const backgroundtypechattheme = new BackgroundTypeChatTheme(rawData, bot);
await backgroundtypechattheme.getGameHighScores(123, 123);
```
...
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  // Auto-fills parameters from the backgroundtypechattheme instance
  await backgroundtypechattheme.getGameHighScores();
});
```
...
You can listen for BackgroundTypeChatTheme events using:

```typescript
// Type-specific handler
bot.onBackgroundTypeChatTheme(async (backgroundtypechattheme: BackgroundTypeChatTheme) => {
  console.log('Received:', backgroundtypechattheme);
  // Use fluent methods
  await backgroundtypechattheme.getUpdates(...);
});

// Generic handler
bot.on('backgroundtypechattheme', async (data: BackgroundTypeChatTheme) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#BackgroundTypeChatTheme).
