...
The `InputRichBlockVideo` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendContact({
  chatId: 123,
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendPoll({
  chatId: 123,
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendChecklist({
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputrichblockvideo = new InputRichBlockVideo(rawData, bot);
await inputrichblockvideo.sendGame({
  chatId: 123,
...
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  // Auto-fills parameters from the inputrichblockvideo instance
  await inputrichblockvideo.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputRichBlockVideo events using:

```typescript
// Type-specific handler
bot.onInputRichBlockVideo(async (inputrichblockvideo: InputRichBlockVideo) => {
  console.log('Received:', inputrichblockvideo);
  // Use fluent methods
  await inputrichblockvideo.sendMessage(...);
});

// Generic handler
bot.on('inputrichblockvideo', async (data: InputRichBlockVideo) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputRichBlockVideo).
