...
| url           | `string` |    No    | Optional. For “text_link” only, URL that will be opened after user taps on the text                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| user          | `User`   |    No    | Optional. For “text_mention” only, the mentioned user                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| language      | `string` |    No    | Optional. For “pre” only, the programming language of the entity text                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| customEmojiId | `string` |    No    | Optional. For “custom_emoji” only, unique identifier of the custom emoji. Use getCustomEmojiStickers to get full information about the sticker                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendChatAction(123, 'example text');
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editForumTopic(123, 123);
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editUserStarSubscription('example text', true);
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendGame({ gameShortName: 'Response' });
});
```
