...
The `MaybeInaccessibleMessage` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.forwardMessage({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendContact({
  chatId: 123,
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendContact({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendPoll({
  chatId: 123,
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendChecklist({
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendDice({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editChatInviteLink({
  chatId: 123,
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editForumTopic(
  123,
  123,
);
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editGeneralForumTopic(
  123,
  "example text",
);
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendGift({
  giftId: "example text",
  chatId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendGift({ giftId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editStory({ businessConnectionId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editEphemeralMessageText({
  chatId: 123,
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editEphemeralMessageMedia({
  chatId: 123,
  ephemeralMessageId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editEphemeralMessageCaption({
  chatId: 123,
  ephemeralMessageId: 123,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.editUserStarSubscription(
  "example text",
  true,
);
```
...
```typescript
const maybeinaccessiblemessage = new MaybeInaccessibleMessage(rawData, bot);
await maybeinaccessiblemessage.sendGame({
  chatId: 123,
...
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  // Auto-fills parameters from the maybeinaccessiblemessage instance
  await maybeinaccessiblemessage.sendGame({ chatId: "Response" });
});
```
...
You can listen for MaybeInaccessibleMessage events using:

```typescript
// Type-specific handler
bot.onMaybeInaccessibleMessage(async (maybeinaccessiblemessage: MaybeInaccessibleMessage) => {
  console.log('Received:', maybeinaccessiblemessage);
  // Use fluent methods
  await maybeinaccessiblemessage.sendMessage(...);
});

// Generic handler
bot.on('maybeinaccessiblemessage', async (data: MaybeInaccessibleMessage) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#MaybeInaccessibleMessage).
