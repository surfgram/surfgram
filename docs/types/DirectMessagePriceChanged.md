...
```typescript
const directmessagepricechanged = new DirectMessagePriceChanged(rawData, bot);
await directmessagepricechanged.sendChatAction(123, 'example text');
```
...
```typescript
const directmessagepricechanged = new DirectMessagePriceChanged(rawData, bot);
await directmessagepricechanged.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const directmessagepricechanged = new DirectMessagePriceChanged(rawData, bot);
await directmessagepricechanged.editForumTopic(123, 123);
```
...
```typescript
const directmessagepricechanged = new DirectMessagePriceChanged(rawData, bot);
await directmessagepricechanged.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const directmessagepricechanged = new DirectMessagePriceChanged(rawData, bot);
await directmessagepricechanged.editUserStarSubscription(123, 'example text');
```
...
bot.onDirectMessagePriceChanged(async (directmessagepricechanged: DirectMessagePriceChanged) => {
  // Auto-fills parameters from the directmessagepricechanged instance
  await directmessagepricechanged.sendGame({ gameShortName: 'Response' });
});
```
