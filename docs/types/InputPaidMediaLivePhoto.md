...
The `InputPaidMediaLivePhoto` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendContact({
  chatId: 123,
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendPoll({
  chatId: 123,
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendChecklist({
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputpaidmedialivephoto = new InputPaidMediaLivePhoto(rawData, bot);
await inputpaidmedialivephoto.sendGame({
  chatId: 123,
...
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  // Auto-fills parameters from the inputpaidmedialivephoto instance
  await inputpaidmedialivephoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputPaidMediaLivePhoto events using:

```typescript
// Type-specific handler
bot.onInputPaidMediaLivePhoto(async (inputpaidmedialivephoto: InputPaidMediaLivePhoto) => {
  console.log('Received:', inputpaidmedialivephoto);
  // Use fluent methods
  await inputpaidmedialivephoto.sendMessage(...);
});

// Generic handler
bot.on('inputpaidmedialivephoto', async (data: InputPaidMediaLivePhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputPaidMediaLivePhoto).
