...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.sendChatAction('example text', 'example text');
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getUserProfilePhotos(123, 123);
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getFile('example text');
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getChatMember(123);
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getForumTopicIconStickers('example text', 123);
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getUserChatBoosts(123);
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getBusinessConnection('example text');
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getMyCommands({} as any, 'example text');
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getMyName('example text');
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getMyDescription('example text');
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getMyShortDescription('example text');
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getMyDefaultAdministratorRights(true);
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getBusinessAccountStarBalance('example text');
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getStickerSet('example text');
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getCustomEmojiStickers(['example text']);
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getMyStarBalance(123, 123);
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getStarTransactions(123, 123);
```
...
```typescript
const videochatstarted = new VideoChatStarted(rawData, bot);
await videochatstarted.getGameHighScores(123, 123);
```
