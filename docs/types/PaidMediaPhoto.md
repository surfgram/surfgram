...
| :--- | :--- | :---: | :--- |
| type | `string` | Yes | Type of the paid media, always “photo” |
| photo | `PhotoSize[]` | Yes | The photo |

## Fluent Methods

The `PaidMediaPhoto` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendContact({
  chatId: 123,
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendContact({ chatId: "Response" });
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendChecklist({
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendChecklist({ businessConnectionId: "Response" });
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendDice({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendGift({ giftId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const paidmediaphoto = new PaidMediaPhoto(rawData, bot);
await paidmediaphoto.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendInvoice({ chatId: "Response" });
});
```
...
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  // Auto-fills parameters from the paidmediaphoto instance
  await paidmediaphoto.sendGame({ chatId: "Response" });
});
```
...
You can listen for PaidMediaPhoto events using:

```typescript
// Type-specific handler
bot.onPaidMediaPhoto(async (paidmediaphoto: PaidMediaPhoto) => {
  console.log('Received:', paidmediaphoto);
  // Use fluent methods
  await paidmediaphoto.sendMessage(...);
});

// Generic handler
bot.on('paidmediaphoto', async (data: PaidMediaPhoto) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#PaidMediaPhoto).
