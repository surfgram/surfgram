...
| :--- | :--- | :---: | :--- |
| type | `string` | Yes | Scope type, must be all\_private\_chats |
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getUserProfileAudios(
  123,
  123,
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getUserPersonalChatMessages(
  123,
  123,
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getManagedBotToken(
  123,
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getManagedBotAccessSettings(
  123,
);
```
...
bot.onBotCommandScopeAllPrivateChats(async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
  // Auto-fills parameters from the botcommandscopeallprivatechats instance
  await botcommandscopeallprivatechats.getBusinessAccountGifts({ businessConnectionId: "Response" });
});
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getUserGifts({
  userId: 123,
...
bot.onBotCommandScopeAllPrivateChats(async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
  // Auto-fills parameters from the botcommandscopeallprivatechats instance
  await botcommandscopeallprivatechats.getUserGifts({ offset: "Response" });
});
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onBotCommandScopeAllPrivateChats(async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
  // Auto-fills parameters from the botcommandscopeallprivatechats instance
  await botcommandscopeallprivatechats.getChatGifts({ offset: "Response" });
});
```
