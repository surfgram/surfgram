...
| :--- | :------- | :------: | :------------------------------------ |
| type | `string` |   Yes    | Scope type, must be all_private_chats |

## Fluent Methods

The `BotCommandScopeAllPrivateChats` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getUpdates({});
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getWebhookInfo({
  url: 'example text',
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getWebhookInfo({ url: 'Response' });
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getMe({
  text: 'example text',
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getMe({ text: 'Response' });
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getUserProfilePhotos(123, 123);
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getUserProfilePhotos();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getFile('example text');
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getFile();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getChat();
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getChatAdministrators();
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getChatMemberCount();
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getChatMember(123);
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getChatMember();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getForumTopicIconStickers('example text', 123);
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getForumTopicIconStickers();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getUserChatBoosts(123);
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getUserChatBoosts();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getBusinessConnection('example text');
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getBusinessConnection();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getMyCommands({} as any, 'example text');
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getMyCommands();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getMyName('example text');
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getMyName();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getMyDescription('example text');
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getMyDescription();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getMyShortDescription('example text');
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getMyShortDescription();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getChatMenuButton();
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getMyDefaultAdministratorRights(true);
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getMyDefaultAdministratorRights();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getAvailableGifts({
  giftId: 'example text',
  userId: 123,
});
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getAvailableGifts({ giftId: 'Response' });
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getBusinessAccountStarBalance('example text');
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getBusinessAccountStarBalance();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getStickerSet('example text');
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getStickerSet();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getCustomEmojiStickers(['example text']);
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getCustomEmojiStickers();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getMyStarBalance(123, 123);
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getMyStarBalance();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getStarTransactions(123, 123);
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getStarTransactions();
  }
);
```
...
```typescript
const botcommandscopeallprivatechats = new BotCommandScopeAllPrivateChats(rawData, bot);
await botcommandscopeallprivatechats.getGameHighScores(123, 123);
```
...
bot.onBotCommandScopeAllPrivateChats(
  async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
    // Auto-fills parameters from the botcommandscopeallprivatechats instance
    await botcommandscopeallprivatechats.getGameHighScores();
  }
);
```
...
You can listen for BotCommandScopeAllPrivateChats events using:

```typescript
// Type-specific handler
bot.onBotCommandScopeAllPrivateChats(async (botcommandscopeallprivatechats: BotCommandScopeAllPrivateChats) => {
  console.log('Received:', botcommandscopeallprivatechats);
  // Use fluent methods
  await botcommandscopeallprivatechats.getUpdates(...);
});

// Generic handler
bot.on('botcommandscopeallprivatechats', async (data: BotCommandScopeAllPrivateChats) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#BotCommandScopeAllPrivateChats).
