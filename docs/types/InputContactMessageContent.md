...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendChatAction(123, 'example text');
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editForumTopic(123, 123);
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editUserStarSubscription(123, 'example text');
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendGame({ gameShortName: 'Response' });
});
```
