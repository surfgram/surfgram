...
The `InputContactMessageContent` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.forwardMessage({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendContact({
  chatId: 123,
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendPoll({
  chatId: 123,
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendChecklist({
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editChatInviteLink({
  chatId: 123,
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editForumTopic(
  123,
  123,
);
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editGeneralForumTopic(
  123,
  "example text",
);
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editStory({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.editUserStarSubscription(
  123,
  "example text",
);
```
...
```typescript
const inputcontactmessagecontent = new InputContactMessageContent(rawData, bot);
await inputcontactmessagecontent.sendGame({
  chatId: 123,
...
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  // Auto-fills parameters from the inputcontactmessagecontent instance
  await inputcontactmessagecontent.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputContactMessageContent events using:

```typescript
// Type-specific handler
bot.onInputContactMessageContent(async (inputcontactmessagecontent: InputContactMessageContent) => {
  console.log('Received:', inputcontactmessagecontent);
  // Use fluent methods
  await inputcontactmessagecontent.sendMessage(...);
});

// Generic handler
bot.on('inputcontactmessagecontent', async (data: InputContactMessageContent) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputContactMessageContent).
