...
| completedByUser | `User` | No | Optional. User that completed the task; omitted if the task wasn't completed by a user |
| completedByChat | `Chat` | No | Optional. Chat that completed the task; omitted if the task wasn't completed by a chat |
