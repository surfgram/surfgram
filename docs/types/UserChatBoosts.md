...
| :----- | :------------ | :------: | :----------------------------------------------- |
| boosts | `ChatBoost[]` |   Yes    | The list of boosts added to the chat by the user |

## Fluent Methods

The `UserChatBoosts` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getUpdates({});
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getWebhookInfo({
  url: 'example text',
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getWebhookInfo({ url: 'Response' });
});
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getMe({ text: 'Response' });
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getUserProfilePhotos(123, 123);
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getUserProfilePhotos();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getFile('example text');
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getChatAdministrators();
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getChatMemberCount();
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getChatMember();
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getForumTopicIconStickers('example text', 123);
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getForumTopicIconStickers();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getUserChatBoosts();
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getBusinessConnection('example text');
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getBusinessConnection();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getMyCommands({} as any, 'example text');
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getMyCommands();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getMyName('example text');
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getMyName();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getMyDescription('example text');
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getMyDescription();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getMyShortDescription('example text');
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getMyShortDescription();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getChatMenuButton();
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getMyDefaultAdministratorRights(true);
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getMyDefaultAdministratorRights();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getAvailableGifts({
  giftId: 'example text',
  payForUpgrade: true,
});
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getBusinessAccountStarBalance('example text');
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getBusinessAccountStarBalance();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getStickerSet('example text');
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getStickerSet();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getCustomEmojiStickers(['example text']);
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getCustomEmojiStickers();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getMyStarBalance(123, 123);
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getMyStarBalance();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getStarTransactions(123, 123);
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getStarTransactions();
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getGameHighScores(123, 'example text');
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getGameHighScores();
});
```
...
You can listen for UserChatBoosts events using:

```typescript
// Type-specific handler
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  console.log('Received:', userchatboosts);
  // Use fluent methods
  await userchatboosts.getUpdates(...);
});

// Generic handler
bot.on('userchatboosts', async (data: UserChatBoosts) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#UserChatBoosts).
