...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getUserProfileAudios(
  123,
  123,
);
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getUserPersonalChatMessages(
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this?.id` | User identifier of the managed bot whose token will be returned |
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getManagedBotToken();
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this?.id` | User identifier of the managed bot whose access settings will be returned |
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getManagedBotAccessSettings();
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getUserGifts({
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getUserGifts({ offset: "Response" });
});
```
...
```typescript
const userchatboosts = new UserChatBoosts(rawData, bot);
await userchatboosts.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onUserChatBoosts(async (userchatboosts: UserChatBoosts) => {
  // Auto-fills parameters from the userchatboosts instance
  await userchatboosts.getChatGifts({ offset: "Response" });
});
```
