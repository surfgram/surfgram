...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getUserProfilePhotos(123, 123);
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getFile('example text');
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getForumTopicIconStickers('example text', 123);
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getBusinessConnection('example text');
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getMyCommands({} as any, 'example text');
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getMyName('example text');
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getMyDescription('example text');
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getMyShortDescription('example text');
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getMyDefaultAdministratorRights(true);
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getBusinessAccountStarBalance('example text');
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getStickerSet('example text');
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getCustomEmojiStickers(['example text']);
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getMyStarBalance(123, 123);
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getStarTransactions(123, 123);
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getGameHighScores('example text');
```
