...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getUserProfileAudios(
  123,
  123,
);
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getUserPersonalChatMessages(
  123,
);
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getManagedBotToken();
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getManagedBotAccessSettings();
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getUserGifts({
...
bot.onChatBoostSourceGiveaway(async (chatboostsourcegiveaway: ChatBoostSourceGiveaway) => {
  // Auto-fills parameters from the chatboostsourcegiveaway instance
  await chatboostsourcegiveaway.getUserGifts({ offset: "Response" });
});
```
...
```typescript
const chatboostsourcegiveaway = new ChatBoostSourceGiveaway(rawData, bot);
await chatboostsourcegiveaway.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onChatBoostSourceGiveaway(async (chatboostsourcegiveaway: ChatBoostSourceGiveaway) => {
  // Auto-fills parameters from the chatboostsourcegiveaway instance
  await chatboostsourcegiveaway.getChatGifts({ offset: "Response" });
});
```
