...
| `messageIds`            | `number[]`           |   Yes    | A JSON-serialized list of 1-100 identifiers of messages in the chat from_chat_id to forward. The identifiers must be specified in a strictly increasing order. |
| `messageThreadId`       | `number`             |    No    | Unique identifier for the target message thread \(topic\) of the forum; for forum supergroups only                                                             |
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendChatAction(123, 'example text');
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editChatSubscriptionInviteLink(123, 'example text');
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editForumTopic(123, 123);
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editGeneralForumTopic(123, 'example text');
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editUserStarSubscription(123, 'example text');
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendGame({ gameShortName: 'Response' });
});
```
