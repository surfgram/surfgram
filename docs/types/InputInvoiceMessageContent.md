...
| providerToken | `string` | No | Optional. Payment provider token, obtained via @BotFather. Pass an empty string for payments in Telegram Stars. |
...
| maxTipAmount | `number` | No | Optional. The maximum accepted amount for tips in the smallest units of the currency \(integer, not float/double\). For example, for a maximum tip of US$ 1.45 pass max\_tip\_amount = 145. See the exp parameter in currencies.json, it shows the number of digits past the decimal point for each currency \(2 for the majority of currencies\). Defaults to 0. Not supported for payments in Telegram Stars. |
| suggestedTipAmounts | `number[]` | No | Optional. A JSON-serialized Array of suggested amounts of tip in the smallest units of the currency \(integer, not float/double\). At most 4 suggested tip amounts can be specified. The suggested tip amounts must be positive, passed in a strictly increased order and must not exceed max\_tip\_amount. |
| providerData | `string` | No | Optional. A JSON-serialized object for data about the invoice, which will be shared with the payment provider. A detailed description of the required fields should be provided by the payment provider. |
| photoUrl | `string` | No | Optional. URL of the product photo for the invoice. Can be a photo of the goods or a marketing image for a service. |
| photoSize | `number` | No | Optional. Photo size in bytes |
| photoWidth | `number` | No | Optional. Photo width |
| photoHeight | `number` | No | Optional. Photo height |
| needName | `boolean` | No | Optional. Pass True if you require the user's full name to complete the order. Ignored for payments in Telegram Stars. |
| needPhoneNumber | `boolean` | No | Optional. Pass True if you require the user's phone number to complete the order. Ignored for payments in Telegram Stars. |
| needEmail | `boolean` | No | Optional. Pass True if you require the user's email address to complete the order. Ignored for payments in Telegram Stars. |
| needShippingAddress | `boolean` | No | Optional. Pass True if you require the user's shipping address to complete the order. Ignored for payments in Telegram Stars. |
| sendPhoneNumberToProvider | `boolean` | No | Optional. Pass True if the user's phone number should be sent to the provider. Ignored for payments in Telegram Stars. |
| sendEmailToProvider | `boolean` | No | Optional. Pass True if the user's email address should be sent to the provider. Ignored for payments in Telegram Stars. |
| isFlexible | `boolean` | No | Optional. Pass True if the final price depends on the shipping method. Ignored for payments in Telegram Stars. |

## Fluent Methods

The `InputInvoiceMessageContent` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.forwardMessage({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.forwardMessage({ chatId: "Response" });
});
```
...
| :--- | :--- | :---: | :--- |
| `chatId` | `number` \| `string` | Yes | Unique identifier for the target chat or username of the target bot, supergroup or channel in the format @username |
| `fromChatId` | `number` \| `string` | Yes | Unique identifier for the chat where the original messages were sent \(or username of the target bot, supergroup or channel in the format @username\) |
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.forwardMessages({
  chatId: 123,
  fromChatId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.forwardMessages({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendContact({
  chatId: 123,
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendContact({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendPoll({
  chatId: 123,
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendChecklist({
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendDice({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendMessageDraft({ text: "Response" });
});
```
...
| Parameter | Type | Required | Description |
| :--- | :--- | :---: | :--- |
| `chatId` | `number` \| `string` | Yes | Unique identifier for the target chat or username of the target bot or supergroup in the format @username. Channel chats and channel direct messages chats aren't supported. |
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editChatInviteLink({
  chatId: 123,
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editChatInviteLink({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editChatSubscriptionInviteLink(
  123,
  "example text",
);
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editForumTopic(
  123,
  123,
);
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editGeneralForumTopic(
  123,
  "example text",
);
```
...
| `chatId` | `number` \| `string` | No | Required if user\_id is not specified. Unique identifier for the chat or username of the channel \(in the format @username\) that will receive the gift. |
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendGift({
  giftId: "example text",
  userId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendGift({ giftId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editStory({
  businessConnectionId: "example text",
  storyId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editStory({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editMessageText({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editMessageCaption({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editMessageCaption({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editMessageMedia({
  media: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editMessageMedia({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editMessageLiveLocation({
  latitude: 123,
  longitude: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editMessageLiveLocation({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editMessageChecklist({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editMessageChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editMessageReplyMarkup({
  businessConnectionId: "example text",
  chatId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editMessageReplyMarkup({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.editUserStarSubscription(
  123,
  "example text",
);
```
...
| Parameter | Type | Required | Description |
| :--- | :--- | :---: | :--- |
| `chatId` | `number` \| `string` | Yes | Unique identifier for the target chat or username of the target bot in the format @username. Games can't be sent to channel direct messages chats and channel chats. |
...
```typescript
const inputinvoicemessagecontent = new InputInvoiceMessageContent(rawData, bot);
await inputinvoicemessagecontent.sendGame({
  chatId: 123,
...
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  // Auto-fills parameters from the inputinvoicemessagecontent instance
  await inputinvoicemessagecontent.sendGame({ chatId: "Response" });
});
```
...
You can listen for InputInvoiceMessageContent events using:

```typescript
// Type-specific handler
bot.onInputInvoiceMessageContent(async (inputinvoicemessagecontent: InputInvoiceMessageContent) => {
  console.log('Received:', inputinvoicemessagecontent);
  // Use fluent methods
  await inputinvoicemessagecontent.sendMessage(...);
});

// Generic handler
bot.on('inputinvoicemessagecontent', async (data: InputInvoiceMessageContent) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#InputInvoiceMessageContent).
