...
bot.onMessageReactionCountUpdated(async (messagereactioncountupdated: MessageReactionCountUpdated) => {
  // Auto-fills parameters from the messagereactioncountupdated instance
  await messagereactioncountupdated.forwardMessage({ messageEffectId: "Response" });
});
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.sendLivePhoto({
  livePhoto: {} as any,
  photo: {} as any,
});
```
...
bot.onMessageReactionCountUpdated(async (messagereactioncountupdated: MessageReactionCountUpdated) => {
  // Auto-fills parameters from the messagereactioncountupdated instance
  await messagereactioncountupdated.sendLivePhoto({ livePhoto: "Response" });
});
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.sendMessageDraft({
  draftId: 123,
  messageThreadId: 123,
});
```
...
bot.onMessageReactionCountUpdated(async (messagereactioncountupdated: MessageReactionCountUpdated) => {
  // Auto-fills parameters from the messagereactioncountupdated instance
  await messagereactioncountupdated.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.sendChatJoinRequestWebApp(
  "example text",
);
```
...
bot.onMessageReactionCountUpdated(async (messagereactioncountupdated: MessageReactionCountUpdated) => {
  // Auto-fills parameters from the messagereactioncountupdated instance
  await messagereactioncountupdated.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.editEphemeralMessageText({
  receiverUserId: 123,
...
bot.onMessageReactionCountUpdated(async (messagereactioncountupdated: MessageReactionCountUpdated) => {
  // Auto-fills parameters from the messagereactioncountupdated instance
  await messagereactioncountupdated.editEphemeralMessageText({ text: "Response" });
});
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.editEphemeralMessageMedia({
  receiverUserId: 123,
  ephemeralMessageId: 123,
});
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.editEphemeralMessageCaption({
  receiverUserId: 123,
  ephemeralMessageId: 123,
});
```
...
bot.onMessageReactionCountUpdated(async (messagereactioncountupdated: MessageReactionCountUpdated) => {
  // Auto-fills parameters from the messagereactioncountupdated instance
  await messagereactioncountupdated.editEphemeralMessageCaption({ caption: "Response" });
});
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.sendRichMessage({
  richMessage: {} as any,
  businessConnectionId: "example text",
});
```
...
bot.onMessageReactionCountUpdated(async (messagereactioncountupdated: MessageReactionCountUpdated) => {
  // Auto-fills parameters from the messagereactioncountupdated instance
  await messagereactioncountupdated.sendRichMessage({ businessConnectionId: "Response" });
});
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.sendRichMessageDraft(
  123,
  {} as any,
);
```
