...
```typescript
bot.onMessageReactionCountUpdated(
  async (messagereactioncountupdated: MessageReactionCountUpdated) => {
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.sendChatAction('example text', 'example text');
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.editChatSubscriptionInviteLink('example text', 'example text');
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.editForumTopic(123, 'example text');
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.editGeneralForumTopic('example text');
```
...
```typescript
const messagereactioncountupdated = new MessageReactionCountUpdated(rawData, bot);
await messagereactioncountupdated.editUserStarSubscription(123, 'example text');
```
