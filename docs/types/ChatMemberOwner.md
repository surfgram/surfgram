...
The `ChatMemberOwner` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getUpdates({});
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getWebhookInfo({
  url: 'example text',
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getWebhookInfo({ url: 'Response' });
});
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getMe({ text: 'Response' });
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getUserProfilePhotos(123, 123);
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getUserProfilePhotos();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getFile('example text');
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getChatAdministrators();
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getChatMemberCount();
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getChatMember();
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getForumTopicIconStickers('example text', 123);
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getForumTopicIconStickers();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getUserChatBoosts();
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getBusinessConnection('example text');
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getBusinessConnection();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getMyCommands({} as any, 'example text');
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getMyCommands();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getMyName('example text');
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getMyName();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getMyDescription('example text');
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getMyDescription();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getMyShortDescription('example text');
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getMyShortDescription();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getChatMenuButton();
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getMyDefaultAdministratorRights(true);
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getMyDefaultAdministratorRights();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getAvailableGifts({
  giftId: 'example text',
  payForUpgrade: true,
});
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getBusinessAccountStarBalance('example text');
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getBusinessAccountStarBalance();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getStickerSet('example text');
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getStickerSet();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getCustomEmojiStickers(['example text']);
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getCustomEmojiStickers();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getMyStarBalance(123, 123);
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getMyStarBalance();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getStarTransactions(123, 123);
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getStarTransactions();
});
```
...
```typescript
const chatmemberowner = new ChatMemberOwner(rawData, bot);
await chatmemberowner.getGameHighScores(123, 'example text');
```
...
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  // Auto-fills parameters from the chatmemberowner instance
  await chatmemberowner.getGameHighScores();
});
```
...
You can listen for ChatMemberOwner events using:

```typescript
// Type-specific handler
bot.onChatMemberOwner(async (chatmemberowner: ChatMemberOwner) => {
  console.log('Received:', chatmemberowner);
  // Use fluent methods
  await chatmemberowner.getUpdates(...);
});

// Generic handler
bot.on('chatmemberowner', async (data: ChatMemberOwner) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#ChatMemberOwner).
