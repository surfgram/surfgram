...
```typescript
const inputmessagecontent = new InputMessageContent(rawData, bot);
await inputmessagecontent.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInputMessageContent(async (inputmessagecontent: InputMessageContent) => {
  // Auto-fills parameters from the inputmessagecontent instance
  await inputmessagecontent.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inputmessagecontent = new InputMessageContent(rawData, bot);
await inputmessagecontent.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
bot.onInputMessageContent(async (inputmessagecontent: InputMessageContent) => {
  // Auto-fills parameters from the inputmessagecontent instance
  await inputmessagecontent.editMessageText({ businessConnectionId: "Response" });
});
```
...
```typescript
const inputmessagecontent = new InputMessageContent(rawData, bot);
await inputmessagecontent.editEphemeralMessageText({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputMessageContent(async (inputmessagecontent: InputMessageContent) => {
  // Auto-fills parameters from the inputmessagecontent instance
  await inputmessagecontent.editEphemeralMessageText({ chatId: "Response" });
});
```
...
```typescript
const inputmessagecontent = new InputMessageContent(rawData, bot);
await inputmessagecontent.editEphemeralMessageMedia({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputMessageContent(async (inputmessagecontent: InputMessageContent) => {
  // Auto-fills parameters from the inputmessagecontent instance
  await inputmessagecontent.editEphemeralMessageMedia({ chatId: "Response" });
});
```
...
```typescript
const inputmessagecontent = new InputMessageContent(rawData, bot);
await inputmessagecontent.editEphemeralMessageCaption({
  chatId: 123,
  receiverUserId: 123,
});
```
...
bot.onInputMessageContent(async (inputmessagecontent: InputMessageContent) => {
  // Auto-fills parameters from the inputmessagecontent instance
  await inputmessagecontent.editEphemeralMessageCaption({ chatId: "Response" });
});
```
...
```typescript
const inputmessagecontent = new InputMessageContent(rawData, bot);
await inputmessagecontent.editEphemeralMessageReplyMarkup(
  123,
  123,
);
```
...
```typescript
const inputmessagecontent = new InputMessageContent(rawData, bot);
await inputmessagecontent.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInputMessageContent(async (inputmessagecontent: InputMessageContent) => {
  // Auto-fills parameters from the inputmessagecontent instance
  await inputmessagecontent.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inputmessagecontent = new InputMessageContent(rawData, bot);
await inputmessagecontent.sendRichMessageDraft(
  123,
  123,
);
```
...
bot.onInputMessageContent(async (inputmessagecontent: InputMessageContent) => {
  // Auto-fills parameters from the inputmessagecontent instance
  await inputmessagecontent.sendGame({ chatId: "Response" });
});
```
