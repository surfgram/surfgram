...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.sendChatAction('example text', 'example text');
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getUserProfilePhotos(123, 123);
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getFile('example text');
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getChatMember(123);
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getForumTopicIconStickers('example text', 123);
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getUserChatBoosts(123);
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getBusinessConnection('example text');
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getMyCommands({} as any, 'example text');
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getMyName('example text');
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getMyDescription('example text');
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getMyShortDescription('example text');
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getMyDefaultAdministratorRights(true);
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getBusinessAccountStarBalance('example text');
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getStickerSet('example text');
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getCustomEmojiStickers(['example text']);
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getMyStarBalance(123, 123);
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getStarTransactions(123, 123);
```
...
```typescript
const videochatended = new VideoChatEnded(rawData, bot);
await videochatended.getGameHighScores(123, 123);
```
