...
```typescript
const inlinequeryresultcachedvideo = new InlineQueryResultCachedVideo(rawData, bot);
await inlinequeryresultcachedvideo.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onInlineQueryResultCachedVideo(async (inlinequeryresultcachedvideo: InlineQueryResultCachedVideo) => {
  // Auto-fills parameters from the inlinequeryresultcachedvideo instance
  await inlinequeryresultcachedvideo.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcachedvideo = new InlineQueryResultCachedVideo(rawData, bot);
await inlinequeryresultcachedvideo.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onInlineQueryResultCachedVideo(async (inlinequeryresultcachedvideo: InlineQueryResultCachedVideo) => {
  // Auto-fills parameters from the inlinequeryresultcachedvideo instance
  await inlinequeryresultcachedvideo.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const inlinequeryresultcachedvideo = new InlineQueryResultCachedVideo(rawData, bot);
await inlinequeryresultcachedvideo.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
```typescript
const inlinequeryresultcachedvideo = new InlineQueryResultCachedVideo(rawData, bot);
await inlinequeryresultcachedvideo.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onInlineQueryResultCachedVideo(async (inlinequeryresultcachedvideo: InlineQueryResultCachedVideo) => {
  // Auto-fills parameters from the inlinequeryresultcachedvideo instance
  await inlinequeryresultcachedvideo.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const inlinequeryresultcachedvideo = new InlineQueryResultCachedVideo(rawData, bot);
await inlinequeryresultcachedvideo.sendRichMessageDraft(
  123,
  123,
);
```
...
bot.onInlineQueryResultCachedVideo(async (inlinequeryresultcachedvideo: InlineQueryResultCachedVideo) => {
  // Auto-fills parameters from the inlinequeryresultcachedvideo instance
  await inlinequeryresultcachedvideo.sendGame({ chatId: "Response" });
});
```
