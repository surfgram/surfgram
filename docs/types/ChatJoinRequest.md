...
```typescript
const chatjoinrequest = new ChatJoinRequest(rawData, bot);
await chatjoinrequest.getUserProfileAudios(
  123,
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.userChatId?.id` | Unique identifier for the target user |
...
```typescript
const chatjoinrequest = new ChatJoinRequest(rawData, bot);
await chatjoinrequest.getUserPersonalChatMessages(
  123,
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.userChatId?.id` | User identifier of the managed bot whose token will be returned |
...
```typescript
const chatjoinrequest = new ChatJoinRequest(rawData, bot);
await chatjoinrequest.getManagedBotToken();
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.userChatId?.id` | User identifier of the managed bot whose access settings will be returned |
...
```typescript
const chatjoinrequest = new ChatJoinRequest(rawData, bot);
await chatjoinrequest.getManagedBotAccessSettings();
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this.userChatId?.id` | Unique identifier of the user |
...
```typescript
const chatjoinrequest = new ChatJoinRequest(rawData, bot);
await chatjoinrequest.getUserGifts({
...
bot.onChatJoinRequest(async (chatjoinrequest: ChatJoinRequest) => {
  // Auto-fills parameters from the chatjoinrequest instance
  await chatjoinrequest.getUserGifts({ offset: "Response" });
});
```
...
```typescript
const chatjoinrequest = new ChatJoinRequest(rawData, bot);
await chatjoinrequest.getChatGifts({
  excludeUnsaved: true,
  excludeSaved: true,
});
```
...
bot.onChatJoinRequest(async (chatjoinrequest: ChatJoinRequest) => {
  // Auto-fills parameters from the chatjoinrequest instance
  await chatjoinrequest.getChatGifts({ offset: "Response" });
});
```
