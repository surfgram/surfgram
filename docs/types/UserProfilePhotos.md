...
| :--- | :--- | :---: | :--- |
| totalCount | `number` | Yes | Total number of profile pictures the target user has |
| photos | `PhotoSize[][]` | Yes | Requested profile pictures \(in up to 4 sizes each\) |

## Fluent Methods

The `UserProfilePhotos` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendMessage({
  chatId: 123,
  text: "example text",
});
```
...
```typescript
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendMessage({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendPhoto({
  chatId: 123,
  photo: {} as any,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendPhoto({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendLivePhoto({
  chatId: 123,
  livePhoto: {} as any,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendLivePhoto({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendAudio({
  chatId: 123,
  audio: {} as any,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendAudio({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendDocument({
  chatId: 123,
  document: {} as any,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendDocument({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendVideo({
  chatId: 123,
  video: {} as any,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendVideo({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendAnimation({
  chatId: 123,
  animation: {} as any,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendAnimation({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendVoice({
  chatId: 123,
  voice: {} as any,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendVoice({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendVideoNote({
  chatId: 123,
  videoNote: {} as any,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendVideoNote({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendPaidMedia({
  chatId: 123,
  starCount: 123,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendPaidMedia({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendMediaGroup({
  chatId: 123,
  media: [{} as any],
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendMediaGroup({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendLocation({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendLocation({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendVenue({
  chatId: 123,
  latitude: 123,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendVenue({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendContact({
  chatId: 123,
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendContact({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendPoll({
  chatId: 123,
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendPoll({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendChecklist({
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendChecklist({ businessConnectionId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendDice({
  chatId: 123,
  businessConnectionId: "example text",
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendDice({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendMessageDraft({
  chatId: 123,
  draftId: 123,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendMessageDraft({ text: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendChatAction(
  123,
  "example text",
);
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.getUserProfilePhotos(
  123,
  123,
);
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendChatJoinRequestWebApp(
  "example text",
  "example text",
);
```
...
| Parameter | Source | Description |
| :--- | :--- | :--- |
| `userId` | `this?.id` | Required if chat_id is not specified. Unique identifier of the target user who will receive the gift. |
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendGift({
  giftId: "example text",
  chatId: 123,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendGift({ giftId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendSticker({
  chatId: 123,
  sticker: {} as any,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendSticker({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendRichMessage({
  chatId: 123,
  richMessage: {} as any,
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendRichMessage({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendRichMessageDraft(
  123,
  123,
);
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendInvoice({
  chatId: 123,
  title: "example text",
});
```
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendInvoice({ chatId: "Response" });
});
```
...
```typescript
const userprofilephotos = new UserProfilePhotos(rawData, bot);
await userprofilephotos.sendGame({
  chatId: 123,
...
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  // Auto-fills parameters from the userprofilephotos instance
  await userprofilephotos.sendGame({ chatId: "Response" });
});
```
...
You can listen for UserProfilePhotos events using:

```typescript
// Type-specific handler
bot.onUserProfilePhotos(async (userprofilephotos: UserProfilePhotos) => {
  console.log('Received:', userprofilephotos);
  // Use fluent methods
  await userprofilephotos.sendMessage(...);
});

// Generic handler
bot.on('userprofilephotos', async (data: UserProfilePhotos) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#UserProfilePhotos).
