...
| keywords     | `string[]`     |    No    | Optional. List of 0-20 search keywords for the sticker with total length of up to 64 characters. For “regular” and “custom_emoji” stickers only.                                                                                                                                                                                                                                                                     |
...
```typescript
const inputsticker = new InputSticker(rawData, bot);
await inputsticker.addStickerToSet(123, 'example text');
```
