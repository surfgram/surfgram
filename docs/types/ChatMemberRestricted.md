...
| canSendVideos         | `boolean` |   Yes    | True, if the user is allowed to send videos                                                                               |
| canSendVideoNotes     | `boolean` |   Yes    | True, if the user is allowed to send video notes                                                                          |
| canSendVoiceNotes     | `boolean` |   Yes    | True, if the user is allowed to send voice notes                                                                          |
...
| canManageTopics       | `boolean` |   Yes    | True, if the user is allowed to create forum topics                                                                       |
| untilDate             | `number`  |   Yes    | Date when restrictions will be lifted for this user; Unix time. If 0, then the user is restricted forever                 |

## Fluent Methods

The `ChatMemberRestricted` class has the following fluent methods that automatically inject contextual parameters:
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getUpdates({
  offset: 123,
  limit: 123,
});
```
...
```typescript
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getUpdates({});
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getWebhookInfo({
  url: 'example text',
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getWebhookInfo({ url: 'Response' });
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getMe({
  text: 'example text',
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getMe({ text: 'Response' });
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getUserProfilePhotos(123, 123);
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getUserProfilePhotos();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getFile('example text');
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getFile();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getChat();
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getChatAdministrators();
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getChatMemberCount();
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getChatMember();
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getForumTopicIconStickers('example text', 123);
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getForumTopicIconStickers();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getUserChatBoosts();
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getBusinessConnection('example text');
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getBusinessConnection();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getMyCommands({} as any, 'example text');
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getMyCommands();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getMyName('example text');
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getMyName();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getMyDescription('example text');
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getMyDescription();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getMyShortDescription('example text');
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getMyShortDescription();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getChatMenuButton();
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getMyDefaultAdministratorRights(true);
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getMyDefaultAdministratorRights();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getAvailableGifts({
  giftId: 'example text',
  payForUpgrade: true,
});
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getAvailableGifts({ giftId: 'Response' });
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getBusinessAccountStarBalance('example text');
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getBusinessAccountStarBalance();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getBusinessAccountGifts({
  businessConnectionId: 'example text',
  excludeUnsaved: true,
});
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getBusinessAccountGifts({ businessConnectionId: 'Response' });
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getStickerSet('example text');
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getStickerSet();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getCustomEmojiStickers(['example text']);
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getCustomEmojiStickers();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getMyStarBalance(123, 123);
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getMyStarBalance();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getStarTransactions(123, 123);
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getStarTransactions();
});
```
...
```typescript
const chatmemberrestricted = new ChatMemberRestricted(rawData, bot);
await chatmemberrestricted.getGameHighScores('example text');
```
...
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  // Auto-fills parameters from the chatmemberrestricted instance
  await chatmemberrestricted.getGameHighScores();
});
```
...
You can listen for ChatMemberRestricted events using:

```typescript
// Type-specific handler
bot.onChatMemberRestricted(async (chatmemberrestricted: ChatMemberRestricted) => {
  console.log('Received:', chatmemberrestricted);
  // Use fluent methods
  await chatmemberrestricted.getUpdates(...);
});

// Generic handler
bot.on('chatmemberrestricted', async (data: ChatMemberRestricted) => {
  // Same as above
});
```
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#ChatMemberRestricted).
