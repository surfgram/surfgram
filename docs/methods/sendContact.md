...
**Available methods:** `sendContact`


[View Contact documentation with fluent methods](../types/Contact.md)
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#sendContact).
