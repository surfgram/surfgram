...
**Auto-filled parameters:** messageThreadId, iconCustomEmojiId
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#editForumTopic).
