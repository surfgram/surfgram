...
### InputPollMedia (1 methods)

**Available methods:** `sendPoll`

**Auto-filled parameters:** chatId

[View InputPollMedia documentation with fluent methods](../types/InputPollMedia.md)

### InputPollOption (1 methods)

**Available methods:** `sendPoll`


[View InputPollOption documentation with fluent methods](../types/InputPollOption.md)
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#sendPoll).
