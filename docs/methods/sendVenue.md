...
**Available methods:** `sendVenue`

**Auto-filled parameters:** foursquareId, googlePlaceId

[View Venue documentation with fluent methods](../types/Venue.md)
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#sendVenue).
