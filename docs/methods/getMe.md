...
**Auto-filled parameters:** chatId, messageThreadId, directMessagesTopicId
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#getMe).
