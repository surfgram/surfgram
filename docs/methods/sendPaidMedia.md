...
**Auto-filled parameters:** chatId, businessConnectionId, messageThreadId, directMessagesTopicId

[View Message documentation with fluent methods](../types/Message.md)

### MessageId (37 methods)
...
### InaccessibleMessage (37 methods)
...
### MaybeInaccessibleMessage (37 methods)
...
### MessageOriginHiddenUser (37 methods)
...
### MessageOriginChannel (37 methods)
...
### PhotoSize (23 methods)

**Available methods:** `sendMessage`, `sendPhoto`, `sendLivePhoto`, `sendAudio`, `sendDocument`, `sendVideo`, `sendAnimation`, `sendVoice`, `sendVideoNote`, `sendPaidMedia`, `sendMediaGroup`, `sendLocation`, `sendVenue`, `sendContact`, `sendPoll`, `sendChecklist`, `sendDice`, `sendMessageDraft`, `sendChatAction`, `sendGift`, `sendSticker`, `sendInvoice`, `sendGame`
...
**Available methods:** `sendPaidMedia`


[View PaidMedia documentation with fluent methods](../types/PaidMedia.md)

### PaidMediaLivePhoto (23 methods)
...
### MessageAutoDeleteTimerChanged (37 methods)
...
### PaidMessagePriceChanged (37 methods)
...
### DirectMessagePriceChanged (37 methods)
...
### DirectMessagesTopic (37 methods)

**Available methods:** `sendMessage`, `forwardMessage`, `forwardMessages`, `sendPhoto`, `sendLivePhoto`, `sendAudio`, `sendDocument`, `sendVideo`, `sendAnimation`, `sendVoice`, `sendVideoNote`, `sendPaidMedia`, `sendMediaGroup`, `sendLocation`, `sendVenue`, `sendContact`, `sendPoll`, `sendChecklist`, `sendDice`, `sendMessageDraft`, `sendChatAction`, `editChatInviteLink`, `editChatSubscriptionInviteLink`, `editForumTopic`, `editGeneralForumTopic`, `sendGift`, `editStory`, `editMessageText`, `editMessageCaption`, `editMessageMedia`, `editMessageLiveLocation`, `editMessageChecklist`, `editMessageReplyMarkup`, `sendSticker`, `sendInvoice`, `editUserStarSubscription`, `sendGame`

**Auto-filled parameters:** directMessagesTopicId
...
### MessageReactionUpdated (37 methods)
...
### MessageReactionCountUpdated (37 methods)
...
### BusinessMessagesDeleted (37 methods)
...
### InputMediaLivePhoto (23 methods)
...
### InputPaidMedia (1 methods)

**Available methods:** `sendPaidMedia`


[View InputPaidMedia documentation with fluent methods](../types/InputPaidMedia.md)

### InputPaidMediaLivePhoto (23 methods)
...
### InputPaidMediaPhoto (23 methods)
...
### InputPaidMediaVideo (23 methods)
...
### InputProfilePhotoStatic (23 methods)
...
### InputProfilePhotoAnimated (23 methods)
...
### InputStoryContentPhoto (23 methods)
...
### InputStoryContentVideo (23 methods)
...
### InlineQueryResultPhoto (23 methods)
...
### InlineQueryResultVideo (23 methods)
...
### InlineQueryResultDocument (23 methods)
...
### InlineQueryResultCachedPhoto (23 methods)
...
### InlineQueryResultCachedDocument (23 methods)
...
### InlineQueryResultCachedVideo (23 methods)
...
### InputMessageContent (37 methods)
...
### InputTextMessageContent (37 methods)
...
### InputLocationMessageContent (37 methods)
...
### InputVenueMessageContent (37 methods)
...
### InputContactMessageContent (37 methods)
...
### InputInvoiceMessageContent (37 methods)
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#sendPaidMedia).
