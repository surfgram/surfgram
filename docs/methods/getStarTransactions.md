...
### ChatFullInfo (28 methods)

**Available methods:** `getUpdates`, `getWebhookInfo`, `getMe`, `getUserProfilePhotos`, `getFile`, `getChat`, `getChatAdministrators`, `getChatMemberCount`, `getChatMember`, `getForumTopicIconStickers`, `getUserChatBoosts`, `getBusinessConnection`, `getMyCommands`, `getMyName`, `getMyDescription`, `getMyShortDescription`, `getChatMenuButton`, `getMyDefaultAdministratorRights`, `getAvailableGifts`, `getBusinessAccountStarBalance`, `getBusinessAccountGifts`, `getUserGifts`, `getChatGifts`, `getStickerSet`, `getCustomEmojiStickers`, `getMyStarBalance`, `getStarTransactions`, `getGameHighScores`
...
### BackgroundTypeChatTheme (28 methods)
...
### KeyboardButtonRequestChat (28 methods)
...
### SwitchInlineQueryChosenChat (28 methods)
...
### ChatMemberAdministrator (28 methods)
...
### ChatMemberRestricted (28 methods)
...
### ChatJoinRequest (30 methods)

**Available methods:** `getUpdates`, `getWebhookInfo`, `getMe`, `getUserProfilePhotos`, `getFile`, `approveChatJoinRequest`, `declineChatJoinRequest`, `getChat`, `getChatAdministrators`, `getChatMemberCount`, `getChatMember`, `getForumTopicIconStickers`, `getUserChatBoosts`, `getBusinessConnection`, `getMyCommands`, `getMyName`, `getMyDescription`, `getMyShortDescription`, `getChatMenuButton`, `getMyDefaultAdministratorRights`, `getAvailableGifts`, `getBusinessAccountStarBalance`, `getBusinessAccountGifts`, `getUserGifts`, `getChatGifts`, `getStickerSet`, `getCustomEmojiStickers`, `getMyStarBalance`, `getStarTransactions`, `getGameHighScores`


[View ChatJoinRequest documentation with fluent methods](../types/ChatJoinRequest.md)

### ChatPermissions (30 methods)

**Available methods:** `getUpdates`, `getWebhookInfo`, `getMe`, `getUserProfilePhotos`, `getFile`, `restrictChatMember`, `setChatPermissions`, `getChat`, `getChatAdministrators`, `getChatMemberCount`, `getChatMember`, `getForumTopicIconStickers`, `getUserChatBoosts`, `getBusinessConnection`, `getMyCommands`, `getMyName`, `getMyDescription`, `getMyShortDescription`, `getChatMenuButton`, `getMyDefaultAdministratorRights`, `getAvailableGifts`, `getBusinessAccountStarBalance`, `getBusinessAccountGifts`, `getUserGifts`, `getChatGifts`, `getStickerSet`, `getCustomEmojiStickers`, `getMyStarBalance`, `getStarTransactions`, `getGameHighScores`


[View ChatPermissions documentation with fluent methods](../types/ChatPermissions.md)

### ChatLocation (28 methods)
...
### BotCommandScopeAllPrivateChats (28 methods)
...
### BotCommandScopeAllGroupChats (28 methods)
...
### BotCommandScopeAllChatAdministrators (28 methods)
...
### BotCommandScopeChat (28 methods)
...
### BotCommandScopeChatAdministrators (28 methods)
...
### BotCommandScopeChatMember (28 methods)
...
### ChatBoostSourcePremium (28 methods)
...
### ChatBoostSourceGiftCode (28 methods)
...
### ChatBoostSourceGiveaway (28 methods)
...
### TransactionPartnerChat (28 methods)
