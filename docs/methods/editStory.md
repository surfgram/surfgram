...
**Auto-filled parameters:** businessConnectionId, storyId
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#editStory).
