...
**Available methods:** `sendAnimation`


[View Animation documentation with fluent methods](../types/Animation.md)
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#sendAnimation).
