...
**Auto-filled parameters:** chatId, fromChatId
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#forwardMessages).
