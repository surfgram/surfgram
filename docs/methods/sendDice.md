...
**Available methods:** `sendDice`


[View Dice documentation with fluent methods](../types/Dice.md)
...
For more details, see the official [Telegram Bot API documentation](https://core.telegram.org/bots/api#sendDice).
