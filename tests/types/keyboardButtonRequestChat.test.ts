...
describe('KeyboardButtonRequestChat', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.userAdministratorRights ?? instance.raw?.user_administrator_rights).toEqual({} as any);
    expect(instance.botAdministratorRights ?? instance.raw?.bot_administrator_rights).toEqual({} as any);
