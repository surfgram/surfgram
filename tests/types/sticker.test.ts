...
describe('Sticker', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.premiumAnimation ?? instance.raw?.premium_animation).toEqual({} as any);
    ...
    expect(instance.needsRepainting ?? instance.raw?.needs_repainting).toEqual(true);
