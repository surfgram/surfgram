...
describe('Message', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.chatOwnerLeft ?? instance.raw?.chat_owner_left).toEqual({} as any);
    expect(instance.chatOwnerChanged ?? instance.raw?.chat_owner_changed).toEqual({} as any);
    ...
    expect(instance.giftUpgradeSent ?? instance.raw?.gift_upgrade_sent).toEqual({} as any);
