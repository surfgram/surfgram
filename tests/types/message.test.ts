...
describe('Message', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.replyToChecklistTaskId ?? instance.raw?.reply_to_checklist_task_id).toEqual(
      123
    );
    ...
    expect(
      instance.messageAutoDeleteTimerChanged ?? instance.raw?.message_auto_delete_timer_changed
    ).toEqual({} as any);
    ...
    expect(instance.proximityAlertTriggered ?? instance.raw?.proximity_alert_triggered).toEqual(
      {} as any
    );
    ...
    expect(
      instance.directMessagePriceChanged ?? instance.raw?.direct_message_price_changed
    ).toEqual({} as any);
    ...
    expect(instance.generalForumTopicHidden ?? instance.raw?.general_forum_topic_hidden).toEqual(
      {} as any
    );
    expect(
      instance.generalForumTopicUnhidden ?? instance.raw?.general_forum_topic_unhidden
    ).toEqual({} as any);
    ...
    expect(instance.paidMessagePriceChanged ?? instance.raw?.paid_message_price_changed).toEqual(
      {} as any
    );
    expect(instance.suggestedPostApproved ?? instance.raw?.suggested_post_approved).toEqual(
      {} as any
    );
    expect(
      instance.suggestedPostApprovalFailed ?? instance.raw?.suggested_post_approval_failed
    ).toEqual({} as any);
    expect(instance.suggestedPostDeclined ?? instance.raw?.suggested_post_declined).toEqual(
      {} as any
    );
    expect(instance.suggestedPostPaid ?? instance.raw?.suggested_post_paid).toEqual({} as any);
    expect(instance.suggestedPostRefunded ?? instance.raw?.suggested_post_refunded).toEqual(
      {} as any
    );
    ...
    expect(
      instance.videoChatParticipantsInvited ?? instance.raw?.video_chat_participants_invited
    ).toEqual({} as any);
