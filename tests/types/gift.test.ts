...
describe('Gift', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.remainingCount ?? instance.raw?.remaining_count).toEqual(123);
    expect(instance.personalTotalCount ?? instance.raw?.personal_total_count).toEqual(123);
    expect(instance.personalRemainingCount ?? instance.raw?.personal_remaining_count).toEqual(123);
    expect(instance.background ?? instance.raw?.background).toEqual({} as any);
    expect(instance.uniqueGiftVariantCount ?? instance.raw?.unique_gift_variant_count).toEqual(123);
