...
describe('ChatInviteLink', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.createsJoinRequest ?? instance.raw?.creates_join_request).toEqual(true);
    ...
    expect(instance.pendingJoinRequestCount ?? instance.raw?.pending_join_request_count).toEqual(123);
    expect(instance.subscriptionPeriod ?? instance.raw?.subscription_period).toEqual(123);
    expect(instance.subscriptionPrice ?? instance.raw?.subscription_price).toEqual(123);
  });
});