...
class TestChatBoostSourceGiftCode:
    ...
    def test_concrete_instantiation(self, concrete_chat_boost_source_gift_code):
        ...
        instance = concrete_chat_boost_source_gift_code()
        assert isinstance(instance, ChatBoostSourceGiftCode)
...
class TestChatBoostSourceGiftCodesFactory:
    ...
    async def test_create_with_valid_trigger(self, registered_handler, mocker):
        ...
        mock_update.chat_boost_source_gift_code = mocker.MagicMock()
