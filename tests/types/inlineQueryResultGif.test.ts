import { InlineQueryResultGif } from "../../src/api";
import { Bot } from "../../src/core/bot";

describe("InlineQueryResultGif", () => {
	...
	it("should correctly instantiate from raw data", () => {
		...
		const instance = new InlineQueryResultGif(raw, mockBot);
		...
		expect(
			instance.thumbnailMimeType ?? instance.raw?.thumbnail_mime_type,
