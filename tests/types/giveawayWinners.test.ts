...
describe('GiveawayWinners', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.additionalChatCount ?? instance.raw?.additional_chat_count).toEqual(123);
    expect(instance.prizeStarCount ?? instance.raw?.prize_star_count).toEqual(123);
    expect(
      instance.premiumSubscriptionMonthCount ?? instance.raw?.premium_subscription_month_count
    ).toEqual(123);
