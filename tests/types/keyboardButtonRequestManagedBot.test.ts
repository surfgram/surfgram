...
describe('KeyboardButtonRequestManagedBot', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.suggestedName ?? instance.raw?.suggested_name).toEqual("example text");
    expect(instance.suggestedUsername ?? instance.raw?.suggested_username).toEqual("example text");
  });
});