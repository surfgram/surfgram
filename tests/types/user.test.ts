...
describe('User', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.languageCode ?? instance.raw?.language_code).toEqual('example text');
    ...
    expect(instance.canReadAllGroupMessages ?? instance.raw?.can_read_all_group_messages).toEqual(
      true
    );
