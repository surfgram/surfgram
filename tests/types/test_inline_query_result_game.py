...
class TestInlineQueryResultGame:
    """Tests for InlineQueryResultGame base class."""
    ...
    @pytest.fixture
    def concrete_inline_query_result_game(self):
        """Concrete InlineQueryResultGame implementation for testing."""
...
class TestInlineQueryResultGamesFactory:
    """Tests for InlineQueryResultGamesFactory factory class."""

    @pytest.fixture(autouse=True)
    def reset_factory(self):
        """Ensure clean state for each test."""
        InlineQueryResultGamesFactory.INLINEQUERYRESULTGAMES_REGISTRY.clear()
