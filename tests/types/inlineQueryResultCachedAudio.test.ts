import { InlineQueryResultCachedAudio } from '../../src/api';
import { Bot } from '../../src/core/bot';

describe('InlineQueryResultCachedAudio', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    const instance = new InlineQueryResultCachedAudio(raw, mockBot);
    ...
    expect(instance.audioFileId ?? instance.raw?.audio_file_id).toEqual("example text");
