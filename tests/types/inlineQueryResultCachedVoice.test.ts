import { InlineQueryResultCachedVoice } from '../../src/api';
import { Bot } from '../../src/core/bot';

describe('InlineQueryResultCachedVoice', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    const instance = new InlineQueryResultCachedVoice(raw, mockBot);
    ...
    expect(instance.voiceFileId ?? instance.raw?.voice_file_id).toEqual("example text");
