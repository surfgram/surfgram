import { InlineQueryResultCachedVideo } from '../../src/api';
import { Bot } from '../../src/core/bot';

describe('InlineQueryResultCachedVideo', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    const instance = new InlineQueryResultCachedVideo(raw, mockBot);
    ...
    expect(instance.videoFileId ?? instance.raw?.video_file_id).toEqual('example text');
