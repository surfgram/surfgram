...
describe('UserRating', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.currentLevelRating ?? instance.raw?.current_level_rating).toEqual(123);
    expect(instance.nextLevelRating ?? instance.raw?.next_level_rating).toEqual(123);
  });
});