import { CommunityChatRemoved } from '../../src/api';
import { Bot } from '../../src/core/bot';

describe('CommunityChatRemoved', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    const instance = new CommunityChatRemoved(raw, mockBot);
    ...
    expect(instance.isNameImplicit ?? instance.raw?.is_name_implicit).toEqual(true);
  });
});