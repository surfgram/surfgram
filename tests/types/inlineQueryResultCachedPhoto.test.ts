import { InlineQueryResultCachedPhoto } from '../../src/api';
import { Bot } from '../../src/core/bot';

describe('InlineQueryResultCachedPhoto', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    const instance = new InlineQueryResultCachedPhoto(raw, mockBot);
    ...
    expect(instance.photoFileId ?? instance.raw?.photo_file_id).toEqual("example text");
