...
describe('Update', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.channelPost ?? instance.raw?.channel_post).toEqual({} as any);
    ...
    expect(instance.shippingQuery ?? instance.raw?.shipping_query).toEqual({} as any);
    expect(instance.preCheckoutQuery ?? instance.raw?.pre_checkout_query).toEqual({} as any);
    expect(instance.purchasedPaidMedia ?? instance.raw?.purchased_paid_media).toEqual({} as any);
    expect(instance.poll ?? instance.raw?.poll).toEqual({} as any);
    expect(instance.pollAnswer ?? instance.raw?.poll_answer).toEqual({} as any);
    expect(instance.myChatMember ?? instance.raw?.my_chat_member).toEqual({} as any);
