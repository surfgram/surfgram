...
describe('Poll', () => {
  ...
  it('should correctly instantiate from raw data', () => {
    ...
    expect(instance.questionEntities ?? instance.raw?.question_entities).toEqual([{} as any]);
    expect(instance.options ?? instance.raw?.options).toEqual([{} as any]);
    expect(instance.totalVoterCount ?? instance.raw?.total_voter_count).toEqual(123);
    ...
    expect(instance.correctOptionId ?? instance.raw?.correct_option_id).toEqual(123);
