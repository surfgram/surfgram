/**
 * Parameters interface for the sendLivePhoto method
 * @interface SendLivePhotoParams
...
export interface SendLivePhotoParams {
  ...
  /**
   * The static photo to send. Pass a file\_id as String to send a photo that exists on the Telegram servers \(recommended\) or upload a new video using multipart/form-data. More information on Sending Files ». Sending live photos by a URL is currently unsupported.
   * @type { InputFile | string }
   * @originalType InputFile or String
   * @required Yes
   */
